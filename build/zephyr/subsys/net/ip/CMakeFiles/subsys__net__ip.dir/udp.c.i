# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
# 11 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 2
const struct log_source_const_data log_const_net_udp __attribute__ ((section("." "log_const_net_udp"))) __attribute__((used)) = { .name = "net_udp", .level = 3 }; extern const struct log_source_const_data log_const_net_udp; extern struct log_source_dynamic_data log_dynamic_net_udp; static const struct log_source_const_data * __log_current_const_data 
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
__attribute__((__unused__)) 
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
= 3 ? &log_const_net_udp : 
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
((void *)0)
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
# 14 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/net_private.h"
...
extern __attribute__((format (printf, 3, 0))) int vsnprintk(char *str, size_t size,
       const char *fmt, va_list ap);
# 15 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/net_private.h" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h" 1
# 24 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h"
...
# 25 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h" 2
...
# 15 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 2
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 2
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 2



int net_udp_create(struct net_pkt *pkt, uint16_t src_port, uint16_t dst_port)
{
 struct net_udp_hdr _hdr_udp_access; struct net_pkt_data_access udp_access = { .data = &_hdr_udp_access, .size = sizeof(struct net_udp_hdr), };
 struct net_udp_hdr *udp_hdr;

 udp_hdr = (struct net_udp_hdr *)net_pkt_get_data(pkt, &udp_access);
 if (!udp_hdr) {
  return -
# 27 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
         105
# 27 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
                ;
 }
...
int net_udp_finalize(struct net_pkt *pkt)
{
 ...
 if (!udp_hdr) {
  return -
# 46 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
         105
# 46 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
                ;
 }
 ...
 udp_hdr->len = ((uint16_t) ((((length) >> 8) & 0xff) | (((length) & 0xff) << 8)));
...
{
 struct net_pkt_data_access udp_access = { .data = 
# 64 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
((void *)0)
# 64 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
, .size = sizeof(struct net_udp_hdr), };
 struct net_pkt_cursor backup;
 struct net_udp_hdr *udp_hdr;
 
# 67 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
_Bool 
# 67 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
     overwrite;
...
# 72 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
                           1
# 72 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
                               );
 ...
 if (net_pkt_skip(pkt, net_pkt_ip_hdr_len(pkt) +
    net_pkt_ip_opts_len(pkt))) {
  udp_hdr = 
# 79 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
           ((void *)0)
# 79 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
               ;
  goto out;
 }
...
# 98 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
_Bool 
# 98 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
     overwrite;

 overwrite = net_pkt_is_being_overwritten(pkt);
 net_pkt_set_overwrite(pkt, 
# 101 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
                           1
# 101 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
                               );
 ...
 if (net_pkt_skip(pkt, net_pkt_ip_hdr_len(pkt) +
    net_pkt_ip_opts_len(pkt))) {
  udp_hdr = 
# 108 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
           ((void *)0)
# 108 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
               ;
  goto out;
 }
...
# 117 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
((__builtin_object_size(
# 117 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
udp_hdr
# 117 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
, 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 117 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
out:
 ...
 return udp_hdr == 
# 124 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
                  ((void *)0) 
# 124 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
                       ? 
# 124 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
                         ((void *)0) 
# 124 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
      ...
      struct net_pkt_data_access *udp_access)
{
 ...
 if (!udp_hdr || net_pkt_set_data(pkt, udp_access)) {
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "DROP: corrupted header" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get()))); } while (
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 ((void *)0)
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 , 0, "%s: " "(%s): " "DROP: corrupted header", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
#pragma GCC diagnostic push
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 ((void *)0)
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "DROP: corrupted header", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "DROP: corrupted header", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); } else { log_2("%s: " "(%s): " "DROP: corrupted header", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), src_level); } } while (
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ); } while (0); } if (
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ) { z_log_printf_arg_checker("(%s): " "DROP: corrupted header", log_strdup(k_thread_name_get(k_current_get()))); } } while (
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 154 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 );
 ...
 if (((uint16_t) ((((udp_hdr->len) >> 8) & 0xff) | (((udp_hdr->len) & 0xff) << 8))) != (net_pkt_get_len(pkt) -
        net_pkt_ip_hdr_len(pkt) -
        net_pkt_ip_opts_len(pkt))) {
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "DROP: Invalid hdr length" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get()))); } while (
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 ((void *)0)
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 , 0, "%s: " "(%s): " "DROP: Invalid hdr length", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
#pragma GCC diagnostic push
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
 28
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "DROP: Invalid hdr length") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "DROP: Invalid hdr length") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "DROP: Invalid hdr length") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "DROP: Invalid hdr length"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "DROP: Invalid hdr length") + 0; double _d = _Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, float : ("%s: " "(%s): " "DROP: Invalid hdr length") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "DROP: Invalid hdr length") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "DROP: Invalid hdr length"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "DROP: Invalid hdr length") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "DROP: Invalid hdr length"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
 28 
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 : _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 ((void *)0)
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "DROP: Invalid hdr length", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "DROP: Invalid hdr length", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); } else { log_2("%s: " "(%s): " "DROP: Invalid hdr length", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), src_level); } } while (
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ); } while (0); } if (
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 ) { z_log_printf_arg_checker("(%s): " "DROP: Invalid hdr length", log_strdup(k_thread_name_get(k_current_get()))); } } while (
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
 0
# 161 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
 );
 ...
 if (1 &&
  ...
  if (net_calc_verify_chksum_udp(pkt) != 0U) {
   do { if (!(1 && ((4U <= 0) || ((0 == 
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  0
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "DROP: checksum mismatch" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get()))); } while (
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  0
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  ((void *)0)
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  , 0, "%s: " "(%s): " "DROP: checksum mismatch", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
#pragma GCC diagnostic push
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
...
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
  28
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "DROP: checksum mismatch") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "DROP: checksum mismatch") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "DROP: checksum mismatch") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "DROP: checksum mismatch"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "DROP: checksum mismatch") + 0; double _d = _Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, float : ("%s: " "(%s): " "DROP: checksum mismatch") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "DROP: checksum mismatch") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "DROP: checksum mismatch"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "DROP: checksum mismatch") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "DROP: checksum mismatch"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3
  28 
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  : _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  ((void *)0)
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "DROP: checksum mismatch", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "DROP: checksum mismatch", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get()))); } else { log_2("%s: " "(%s): " "DROP: checksum mismatch", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), src_level); } } while (
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  0
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  ); } while (0); } if (
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  0
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  ) { z_log_printf_arg_checker("(%s): " "DROP: checksum mismatch", log_strdup(k_thread_name_get(k_current_get()))); } } while (
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
  0
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
  );
...
drop:
 ...
 return 
# 185 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c" 3 4
       ((void *)0)
# 185 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/udp.c"
           ;
}

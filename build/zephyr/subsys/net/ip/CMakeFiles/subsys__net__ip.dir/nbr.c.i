# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
# 9 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
...
# 10 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 2
const struct log_source_const_data log_const_net_nbr __attribute__ ((section("." "log_const_net_nbr"))) __attribute__((used)) = { .name = "net_nbr", .level = 3 }; extern const struct log_source_const_data log_const_net_nbr; extern struct log_source_dynamic_data log_dynamic_net_nbr; static const struct log_source_const_data * __log_current_const_data 
# 10 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
__attribute__((__unused__)) 
# 10 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
= 3 ? &log_const_net_nbr : 
# 10 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
((void *)0)
# 10 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
...
# 15 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 2

# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/net_private.h" 1
# 15 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/net_private.h"
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h" 1
# 27 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h"
...
# 28 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h" 2
...
# 29 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_context.h" 2
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/net_private.h" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_pkt.h" 1
# 29 "/home/sebin/thesis/zephyrproject/zephyr/include/net/net_pkt.h"
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/net_private.h" 2
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 2
...
# 19 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 2

struct net_nbr_lladdr net_neighbor_lladdr[8] = { };
...

{
 ...
 do { if (!(1 && ((4U <= 0) || ((0 == 
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
0
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "nbr %p ref %u" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), nbr, nbr->ref - 1); } while (
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
0
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
((void *)0)
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
, 0, "%s: " "(%s): " "nbr %p ref %u", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), nbr, nbr->ref - 1); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
#pragma GCC diagnostic push
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
...
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
28
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "nbr %p ref %u") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "nbr %p ref %u") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "nbr %p ref %u") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "nbr %p ref %u"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "nbr %p ref %u") + 0; double _d = _Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : ("%s: " "(%s): " "nbr %p ref %u") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "nbr %p ref %u") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "nbr %p ref %u"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "nbr %p ref %u"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr) + 0))) > (1)) ? (_Generic((nbr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr) + 0; size_t _arg_size = _Generic((nbr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr) + 0; double _d = _Generic((nbr) + 0, float : (nbr) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr) + 0; size_t _arg_size = _Generic((nbr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->ref - 1) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->ref - 1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->ref - 1) + 0))) > (1)) ? (_Generic((nbr->ref - 1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->ref - 1) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->ref - 1) + 0; size_t _arg_size = _Generic((nbr->ref - 1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->ref - 1) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->ref - 1) + 0; double _d = _Generic((nbr->ref - 1) + 0, float : (nbr->ref - 1) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->ref - 1) + 0; size_t _arg_size = _Generic((nbr->ref - 1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->ref - 1) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->ref - 1) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->ref - 1; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
28 
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
: _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
((void *)0)
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "nbr %p ref %u", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), nbr, nbr->ref - 1); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "nbr %p ref %u", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), nbr, nbr->ref - 1); } else { do { log_arg_t args[] = {(log_arg_t)((const char *)__func__) , (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))) , (log_arg_t)(nbr) , (log_arg_t)(nbr->ref - 1)}; log_n("%s: " "(%s): " "nbr %p ref %u", args, ((long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(args), __typeof__(&(args)[0])))]) - 1) + (sizeof(args) / sizeof((args)[0])))), src_level); } while (
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
0
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
); } } while (
...
0
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
) { z_log_printf_arg_checker("(%s): " "nbr %p ref %u", log_strdup(k_thread_name_get(k_current_get())), nbr, nbr->ref - 1); } } while (
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
0
# 32 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
);
...

{
 ...
 do { if (!(1 && ((4U <= 0) || ((0 == 
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
0
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "nbr %p ref %u" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), nbr, nbr->ref + 1); } while (
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
0
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
...
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
28
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "nbr %p ref %u") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "nbr %p ref %u") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "nbr %p ref %u") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "nbr %p ref %u"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "nbr %p ref %u") + 0; double _d = _Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : ("%s: " "(%s): " "nbr %p ref %u") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "nbr %p ref %u") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "nbr %p ref %u"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "nbr %p ref %u") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "nbr %p ref %u"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr) + 0))) > (1)) ? (_Generic((nbr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr) + 0; size_t _arg_size = _Generic((nbr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr) + 0; double _d = _Generic((nbr) + 0, float : (nbr) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr) + 0; size_t _arg_size = _Generic((nbr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->ref + 1) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->ref + 1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->ref + 1) + 0))) > (1)) ? (_Generic((nbr->ref + 1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->ref + 1) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->ref + 1) + 0; size_t _arg_size = _Generic((nbr->ref + 1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->ref + 1) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->ref + 1) + 0; double _d = _Generic((nbr->ref + 1) + 0, float : (nbr->ref + 1) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->ref + 1) + 0; size_t _arg_size = _Generic((nbr->ref + 1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->ref + 1) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->ref + 1) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->ref + 1; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
...
struct net_nbr *net_nbr_get(struct net_nbr_table *table)
{
 ...
 return 
# 83 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
       ((void *)0)
# 83 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
           ;
}
   ...
   const struct net_linkaddr *lladdr)
{
 ...
 if (nbr->idx != 0xff) {
  return -
# 92 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
         120
# 92 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
                 ;
 }
 ...
 if (avail < 0) {
  return -
# 117 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
         2
# 117 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
               ;
 }
...
int net_nbr_unlink(struct net_nbr *nbr, struct net_linkaddr *lladdr)
{
 ...
 if (nbr->idx == 0xff) {
  return -
# 141 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
         120
# 141 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
                 ;
 }
 ...
 if (!net_neighbor_lladdr[nbr->idx].ref) {
  (void)
# 150 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
       ((__builtin_object_size(
# 150 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
...
# 151 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
                                                         ;
 }

 nbr->idx = 0xff;
 nbr->iface = 
# 155 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
             ((void *)0)
# 155 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
                 ;
          ...
          struct net_linkaddr *lladdr)
{
 ...
 return 
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
       ((void *)0)
# 177 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
           ;
}
...
void net_nbr_print(struct net_nbr_table *table)
{
 if (3 >= 4U) {
  ...
  for (i = 0; i < table->nbr_count; i++) {
   ...
   do { if (!(1 && ((4U <= 0) || ((0 == 
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  0
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), i, nbr, nbr->data, nbr->ref, nbr->iface, nbr->idx, nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))); } while (
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  0
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic ignored "-Wpointer-arith"
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
   int _rv = (((_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((i) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((nbr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((nbr->data) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((nbr->ref) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((nbr->iface) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((nbr->idx) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) - 1) > 0);
...
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  ((void *)0)
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  , 0, "%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), i, nbr, nbr->data, nbr->ref, nbr->iface, nbr->idx, nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
...
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
  28
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0; double _d = _Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, float : ("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((i) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((i) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i) + 0))) > (1)) ? (_Generic((i) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (i) + 0; size_t _arg_size = _Generic((i), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((i) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (i) + 0; double _d = _Generic((i) + 0, float : (i) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (i) + 0; size_t _arg_size = _Generic((i), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((i) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((i) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = i; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr) + 0))) > (1)) ? (_Generic((nbr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr) + 0; size_t _arg_size = _Generic((nbr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr) + 0; double _d = _Generic((nbr) + 0, float : (nbr) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr) + 0; size_t _arg_size = _Generic((nbr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->data) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->data) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->data) + 0))) > (1)) ? (_Generic((nbr->data) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->data) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->data) + 0; size_t _arg_size = _Generic((nbr->data), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->data) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->data) + 0; double _d = _Generic((nbr->data) + 0, float : (nbr->data) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->data) + 0; size_t _arg_size = _Generic((nbr->data), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->data) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->data) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->data; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->ref) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->ref) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->ref) + 0))) > (1)) ? (_Generic((nbr->ref) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->ref) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->ref) + 0; size_t _arg_size = _Generic((nbr->ref), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->ref) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->ref) + 0; double _d = _Generic((nbr->ref) + 0, float : (nbr->ref) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->ref) + 0; size_t _arg_size = _Generic((nbr->ref), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->ref) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->ref) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->ref; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->iface) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->iface) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->iface) + 0))) > (1)) ? (_Generic((nbr->iface) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->iface) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->iface) + 0; size_t _arg_size = _Generic((nbr->iface), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->iface) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->iface) + 0; double _d = _Generic((nbr->iface) + 0, float : (nbr->iface) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->iface) + 0; size_t _arg_size = _Generic((nbr->iface), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->iface) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->iface) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->iface; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->idx) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->idx) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->idx) + 0))) > (1)) ? (_Generic((nbr->idx) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->idx) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->idx) + 0; size_t _arg_size = _Generic((nbr->idx), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->idx) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->idx) + 0; double _d = _Generic((nbr->idx) + 0, float : (nbr->idx) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->idx) + 0; size_t _arg_size = _Generic((nbr->idx), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->idx) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->idx) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->idx; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0))) > (1)) ? (_Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0; size_t _arg_size = _Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0; double _d = _Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, float : (nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0; size_t _arg_size = _Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len)); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3
  28 
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  : _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  ((void *)0)
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), i, nbr, nbr->data, nbr->ref, nbr->iface, nbr->idx, nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), i, nbr, nbr->data, nbr->ref, nbr->iface, nbr->idx, nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))); } else { do { log_arg_t args[] = {(log_arg_t)((const char *)__func__) , (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))) , (log_arg_t)(i) , (log_arg_t)(nbr) , (log_arg_t)(nbr->data) , (log_arg_t)(nbr->ref) , (log_arg_t)(nbr->iface) , (log_arg_t)(nbr->idx) , (log_arg_t)(nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len)))}; log_n("%s: " "(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s", args, ((long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(args), __typeof__(&(args)[0])))]) - 1) + (sizeof(args) / sizeof((args)[0])))), src_level); } while (
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  0
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  ); } } while (
...
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  0
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  ) { z_log_printf_arg_checker("(%s): " "[%d] nbr %p data %p ref %d iface %p idx %d " "ll %s", log_strdup(k_thread_name_get(k_current_get())), i, nbr, nbr->data, nbr->ref, nbr->iface, nbr->idx, nbr->idx == 0xff ? "<unknown>" : log_strdup(net_sprint_ll_addr( net_neighbor_lladdr[nbr->idx].lladdr.addr, net_neighbor_lladdr[nbr->idx].lladdr.len))); } } while (
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c" 3 4
  0
# 220 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/ip/nbr.c"
  )

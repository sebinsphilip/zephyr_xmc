# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
# 13 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 2
const struct log_source_const_data log_const_net_buf __attribute__ ((section("." "log_const_net_buf"))) __attribute__((used)) = { .name = "net_buf", .level = 3 }; extern const struct log_source_const_data log_const_net_buf; extern struct log_source_dynamic_data log_dynamic_net_buf; static const struct log_source_const_data * __log_current_const_data 
# 13 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
__attribute__((__unused__)) 
# 13 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
= 3 ? &log_const_net_buf : 
# 13 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
((void *)0)
# 13 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 2

# 1 "/home/sebin/LIOT/gcc-arm-none-eabi-9-2019-q4-major/lib/gcc/arm-none-eabi/9.2.1/include/stddef.h" 1 3 4
# 18 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 2
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/include/sys/byteorder.h" 2
...
# 20 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 2
...
# 22 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 2
# 46 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
{
 struct net_buf_pool *pool = net_buf_pool_get(buf->pool_id);
 size_t struct_size = (((unsigned long)(sizeof(struct net_buf) + pool->user_data_size) + ((unsigned long)(__alignof__(struct net_buf)) - 1)) & ~((unsigned long)(__alignof__(struct net_buf)) - 1))
                                ;
     ...
     k_timeout_t timeout)
{
 ...
 if (b == 
# 112 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
         ((void *)0)
# 112 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
             ) {
  return 
# 113 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        ((void *)0)
# 113 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
            ;
 }
...
# 206 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...

{
 ...
 if (pool->uninit_count) {
  ...
  if (pool->uninit_count < pool->buf_count) {
   buf = ({ do { } while (
# 264 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        0
# 264 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
        ); void *ret = k_queue_get(&(&pool->free)->_queue, ((k_timeout_t) {0})); do { } while (
# 264 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        0
# 264 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
        ); ret; });
 ...
 k_spin_unlock(&pool->lock, key);
# 307 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
 buf = ({ do { } while (
# 307 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
      0
# 307 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
      ); void *ret = k_queue_get(&(&pool->free)->_queue, timeout); do { } while (
# 307 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
      0
# 307 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
      ); ret; });
 ...
 if (!buf) {
  ;
  return 
# 311 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        ((void *)0)
# 311 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
            ;
 }
...
success:
 ...
 if (size) {
  ...
  if (!((timeout).ticks == (((k_timeout_t) {0})).ticks) &&
      !((timeout).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks)) {
   int64_t remaining = end - sys_clock_tick_get();

   if (remaining <= 0) {
    timeout = ((k_timeout_t) {0});
   } else {
    timeout = ((k_timeout_t) { .ticks = (remaining) });
   }
  }
  ...
  if (!buf->__buf) {
   ...
   net_buf_destroy(buf);
   return 
# 337 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
         ((void *)0)
# 337 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
             ;
  }
  ...
  buf->__buf = 
# 344 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
              ((void *)0)
# 344 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                  ;
 }
 ...
 buf->flags = 0U;
 buf->frags = 
# 349 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
             ((void *)0)
# 349 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                 ;
 buf->size = size;
 net_buf_reset(buf);
...
# 371 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
# 386 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...

{
 ...
 if (!buf) {
  return 
# 399 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        ((void *)0)
# 399 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
            ;
 }
...

{
 ...
 buf = ({ do { } while (
# 419 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
      0
# 419 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
      ); void *ret = k_queue_get(&(fifo)->_queue, timeout); do { } while (
# 419 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
      0
# 419 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
      ); ret; });
 if (!buf) {
  return 
# 421 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        ((void *)0)
# 421 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
            ;
 }
 ...
 for (frag = buf; (frag->flags & (1UL << (0))); frag = frag->frags) {
  frag->frags = ({ do { } while (
# 428 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
               0
# 428 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
               ); void *ret = k_queue_get(&(fifo)->_queue, ((k_timeout_t) {0})); do { } while (
# 428 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
               0
# 428 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
               ); ret; });
 ...
 frag->frags = 
# 436 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
              ((void *)0)
# 436 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                  ;
...
struct net_buf *net_buf_slist_get(sys_slist_t *list)
{
 ...
 if (buf) {
  ...
  frag->frags = 
# 500 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
               ((void *)0)
# 500 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                   ;
 }
...
void net_buf_put(struct k_fifo *fifo, struct net_buf *buf)
{
 ...
 ({ do { } while (
# 519 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
0
# 519 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
); k_queue_append_list(&(fifo)->_queue, buf, tail); do { } while (
# 519 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
0
# 519 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
); });
...
# 541 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
  ...
  if (buf->__buf) {
   ...
   buf->__buf = 
# 550 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
               ((void *)0)
# 550 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                   ;
  }

  buf->data = 
# 553 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
             ((void *)0)
# 553 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                 ;
  buf->frags = 
# 554 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
              ((void *)0)
# 554 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                  ;
...
struct net_buf *net_buf_clone(struct net_buf *buf, k_timeout_t timeout)
{
 ...
 if (!clone) {
  return 
# 595 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
        ((void *)0)
# 595 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
            ;
 }
 ...
 if (pool->alloc->cb->ref && !(buf->flags & (1UL << (1)))) {
  ...
  if (!clone->__buf || size < buf->size) {
   ...
   return 
# 623 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
         ((void *)0)
# 623 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
             ;
  }
...

{
 ...
 frag->frags = 
# 690 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3 4
              ((void *)0)
# 690 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
                  ;
...
# 722 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
 ((__builtin_object_size(
# 722 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
 (uint8_t *)dst + copied
# 722 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
...
# 796 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
void net_buf_simple_clone(const struct net_buf_simple *original,
     struct net_buf_simple *clone)
{
 
# 799 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
((__builtin_object_size(
# 799 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
clone
# 799 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
, 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 799 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
        ...
        size_t len)
{
 ...
 return 
# 819 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
       ((__builtin_object_size(
# 819 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
uint16_t net_buf_simple_remove_le16(struct net_buf_simple *buf)
{
 ...
 ptr = net_buf_simple_remove_mem(buf, sizeof(val));
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((uint16_t *)ptr)) __v; } *__p = (__typeof__(__p)) ((uint16_t *)ptr); __p->__v; });
...
# 951 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 951 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;
 void *ptr;

 ptr = net_buf_simple_remove_mem(buf, sizeof(val));
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((struct uint24 *)ptr)) __v; } *__p = (__typeof__(__p)) ((struct uint24 *)ptr); __p->__v; });
...
# 964 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 964 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;
 void *ptr;
...
uint32_t net_buf_simple_remove_le32(struct net_buf_simple *buf)
{
 ...
 ptr = net_buf_simple_remove_mem(buf, sizeof(val));
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((uint32_t *)ptr)) __v; } *__p = (__typeof__(__p)) ((uint32_t *)ptr); __p->__v; });
...
# 999 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 999 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;
 void *ptr;

 ptr = net_buf_simple_remove_mem(buf, sizeof(val));
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((struct uint48 *)ptr)) __v; } *__p = (__typeof__(__p)) ((struct uint48 *)ptr); __p->__v; });
...
# 1012 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 1012 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;
 void *ptr;
...
uint64_t net_buf_simple_remove_le64(struct net_buf_simple *buf)
{
 ...
 ptr = net_buf_simple_remove_mem(buf, sizeof(val));
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((uint64_t *)ptr)) __v; } *__p = (__typeof__(__p)) ((uint64_t *)ptr); __p->__v; });
         ...
         size_t len)
{
 ...
 return 
# 1059 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
       ((__builtin_object_size(
# 1059 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
...
uint16_t net_buf_simple_pull_le16(struct net_buf_simple *buf)
{
 ...
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((uint16_t *)buf->data)) __v; } *__p = (__typeof__(__p)) ((uint16_t *)buf->data); __p->__v; });
...
# 1197 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 1197 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;

 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((struct uint24 *)buf->data)) __v; } *__p = (__typeof__(__p)) ((struct uint24 *)buf->data); __p->__v; });
 net_buf_simple_pull(buf, sizeof(val));
...
# 1209 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 1209 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;
...
uint32_t net_buf_simple_pull_le32(struct net_buf_simple *buf)
{
 ...
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((uint32_t *)buf->data)) __v; } *__p = (__typeof__(__p)) ((uint32_t *)buf->data); __p->__v; });
 net_buf_simple_pull(buf, sizeof(val));
...
# 1241 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 1241 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;

 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((struct uint48 *)buf->data)) __v; } *__p = (__typeof__(__p)) ((struct uint48 *)buf->data); __p->__v; });
 net_buf_simple_pull(buf, sizeof(val));
...
# 1253 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c" 3
  __attribute__((__packed__)) 
# 1253 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/buf.c"
           val;
...
uint64_t net_buf_simple_pull_le64(struct net_buf_simple *buf)
{
 ...
 val = __extension__ ({ struct __attribute__((__packed__)) { __typeof__(*((uint64_t *)buf->data)) __v; } *__p = (__typeof__(__p)) ((uint64_t *)buf->data); __p->__v; });
 net_buf_simple_pull(buf, sizeof(val));

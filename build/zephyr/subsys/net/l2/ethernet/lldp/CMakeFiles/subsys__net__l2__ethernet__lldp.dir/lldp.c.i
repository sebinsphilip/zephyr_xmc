# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
# 11 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 2
const struct log_source_const_data log_const_net_lldp __attribute__ ((section("." "log_const_net_lldp"))) __attribute__((used)) = { .name = "net_lldp", .level = 3 }; extern const struct log_source_const_data log_const_net_lldp; extern struct log_source_dynamic_data log_dynamic_net_lldp; static const struct log_source_const_data * __log_current_const_data 
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
__attribute__((__unused__)) 
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
= 3 ? &log_const_net_lldp : 
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
((void *)0)
# 12 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 2
...
# 18 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/net/ethernet.h" 1
# 21 "/home/sebin/thesis/zephyrproject/zephyr/include/net/ethernet.h"
...
# 22 "/home/sebin/thesis/zephyrproject/zephyr/include/net/ethernet.h" 2
...
# 23 "/home/sebin/thesis/zephyrproject/zephyr/include/net/ethernet.h" 2
...
# 19 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 2
...
static int lldp_find(struct ethernet_context *ctx, struct net_if *iface)
{
 ...
 for (i = 0; i < ((long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(ctx->lldp), __typeof__(&(ctx->lldp)[0])))]) - 1) + (sizeof(ctx->lldp) / sizeof((ctx->lldp)[0])))); i++) {
  if (ctx->lldp[i].iface == iface) {
   return i;
  }

  if (found < 0 && ctx->lldp[i].iface == 
# 41 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
                                        ((void *)0)
# 41 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
                                            ) {
   found = i;
  }
 }
 ...
 return -
# 51 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
        2
# 51 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
              ;
}
...
static void lldp_submit_work(uint32_t timeout)
{
 ...
 k_work_reschedule(&lldp_tx_timer, ((k_timeout_t) { .ticks = ((k_ticks_t)k_ms_to_ticks_ceil64((((timeout) > (0)) ? (timeout) : (0)))) }));

 do { if (!(1 && ((4U <= 0) || ((0 == 
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
0
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "Next wakeup in %d ms" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))); } while (
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
0
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
((void *)0)
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
, 0, "%s: " "(%s): " "Next wakeup in %d ms", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
...
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
28
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "Next wakeup in %d ms") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "Next wakeup in %d ms") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "Next wakeup in %d ms") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "Next wakeup in %d ms"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "Next wakeup in %d ms") + 0; double _d = _Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, float : ("%s: " "(%s): " "Next wakeup in %d ms") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "Next wakeup in %d ms") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "Next wakeup in %d ms"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "Next wakeup in %d ms") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "Next wakeup in %d ms"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0))) > (1)) ? (_Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0; size_t _arg_size = _Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0; double _d = _Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, float : (k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0; size_t _arg_size = _Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer)); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
28 
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
((void *)0)
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "Next wakeup in %d ms", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "Next wakeup in %d ms", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))); } else { log_3("%s: " "(%s): " "Next wakeup in %d ms", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), (log_arg_t)(k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))), src_level); } } while (
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
0
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
); } while (0); } if (
...
0
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
) { z_log_printf_arg_checker("(%s): " "Next wakeup in %d ms", log_strdup(k_thread_name_get(k_current_get())), k_ticks_to_ms_ceil32( k_work_delayable_remaining_get(&lldp_tx_timer))); } } while (
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
0
# 59 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
)
...
static 
# 64 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
      _Bool 
# 64 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
           lldp_check_timeout(int64_t start, uint32_t time, int64_t timeout)
{
 start += time;
 start = llabs(start);
 ...
 if (start > timeout) {
  return 
# 70 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
        0
# 70 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
             ;
 }

 return 
# 73 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
       1
# 73 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
           ;
}

static 
# 76 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
      _Bool 
# 76 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
           lldp_timedout(struct ethernet_lldp *lldp, int64_t timeout)
{
...
static int lldp_send(struct ethernet_lldp *lldp)
{
 ...
 if (!lldp->lldpdu) {
  ...
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "The LLDPDU is not set for lldp %p" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), lldp); } while (
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 ((void *)0)
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 , 0, "%s: " "(%s): " "The LLDPDU is not set for lldp %p", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), lldp); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
#pragma GCC diagnostic push
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
 28
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0; double _d = _Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, float : ("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "The LLDPDU is not set for lldp %p") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "The LLDPDU is not set for lldp %p"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((lldp) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((lldp) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((lldp) + 0))) > (1)) ? (_Generic((lldp) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((lldp) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (lldp) + 0; size_t _arg_size = _Generic((lldp), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((lldp) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (lldp) + 0; double _d = _Generic((lldp) + 0, float : (lldp) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (lldp) + 0; size_t _arg_size = _Generic((lldp), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((lldp) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((lldp) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = lldp; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
 28 
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 : _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 ((void *)0)
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "The LLDPDU is not set for lldp %p", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), lldp); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "The LLDPDU is not set for lldp %p", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), lldp); } else { log_3("%s: " "(%s): " "The LLDPDU is not set for lldp %p", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), (log_arg_t)(lldp), src_level); } } while (
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); } while (0); } if (
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ) { z_log_printf_arg_checker("(%s): " "The LLDPDU is not set for lldp %p", log_strdup(k_thread_name_get(k_current_get())), lldp); } } while (
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 100 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 );
  ret = -
# 101 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
        22
# 101 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
              ;
  goto out;
 }
 ...
 pkt = net_pkt_alloc_with_buffer(lldp->iface, len, 0, 0,
     ((k_timeout_t) { .ticks = ((k_ticks_t)k_ms_to_ticks_ceil64((((50) > (0)) ? (50) : (0)))) }));
 if (!pkt) {
  ret = -
# 118 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
        12
# 118 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
              ;
  goto out;
 }

 net_pkt_set_lldp(pkt, 
# 122 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
                      1
# 122 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
                          );
 ...
 if (1) {
  uint16_t tlv_end = ((uint16_t) ((((0x0000) >> 8) & 0xff) | (((0x0000) & 0xff) << 8)));
 ...
 if (net_if_send_data(lldp->iface, pkt) == NET_DROP) {
  net_pkt_unref(pkt);
  ret = -
# 157 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
        5
# 157 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
           ;
 }
...
{
 uint32_t timeout_update = 0xffffffffUL - 1;
 int64_t timeout = k_uptime_get();
 struct ethernet_lldp *current, *next;

 (void)(work);

 for (current = ((sys_slist_peek_head(&lldp_ifaces)) ? ((__typeof__(*(current)) *)(((char *)((sys_slist_peek_head(&lldp_ifaces)))) - 
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
__builtin_offsetof (
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
__typeof__(*(current))
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
, 
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
((void *)0)
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
), next = ((current) ? ((sys_slist_peek_next(&((current)->node))) ? ((__typeof__(*(current)) *)(((char *)((sys_slist_peek_next(&((current)->node))))) - 
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
__builtin_offsetof (
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
__typeof__(*(current))
...
((void *)0)
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
; current = next, next = ((current) ? ((sys_slist_peek_next(&((current)->node))) ? ((__typeof__(*(current)) *)(((char *)((sys_slist_peek_next(&((current)->node))))) - 
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
__builtin_offsetof (
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
__typeof__(*(current))
...
# 188 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ...
 if (timeout_update < (0xffffffffUL - 1)) {
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "Waiting for %u ms" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), timeout_update); } while (
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 ((void *)0)
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 , 0, "%s: " "(%s): " "Waiting for %u ms", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), timeout_update); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
#pragma GCC diagnostic push
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
 28
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "Waiting for %u ms") + 0))) > (1)) ? (_Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%s: " "(%s): " "Waiting for %u ms") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%s: " "(%s): " "Waiting for %u ms") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "Waiting for %u ms"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%s: " "(%s): " "Waiting for %u ms") + 0; double _d = _Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, float : ("%s: " "(%s): " "Waiting for %u ms") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%s: " "(%s): " "Waiting for %u ms") + 0; size_t _arg_size = _Generic(("%s: " "(%s): " "Waiting for %u ms"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%s: " "(%s): " "Waiting for %u ms") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%s: " "(%s): " "Waiting for %u ms"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((const char *)__func__) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) > (1)) ? (_Generic(((const char *)__func__) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((const char *)__func__) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((const char *)__func__) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((const char *)__func__) + 0; double _d = _Generic(((const char *)__func__) + 0, float : ((const char *)__func__) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((const char *)__func__) + 0; size_t _arg_size = _Generic(((const char *)__func__), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((const char *)__func__) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((const char *)__func__) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (const char *)__func__; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) > (1)) ? (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(k_thread_name_get(k_current_get()))) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; double _d = _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : (log_strdup(k_thread_name_get(k_current_get()))) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(k_thread_name_get(k_current_get()))) + 0; size_t _arg_size = _Generic((log_strdup(k_thread_name_get(k_current_get()))), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(k_thread_name_get(k_current_get()))) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(k_thread_name_get(k_current_get())); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((timeout_update) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((timeout_update) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((timeout_update) + 0))) > (1)) ? (_Generic((timeout_update) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((timeout_update) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (timeout_update) + 0; size_t _arg_size = _Generic((timeout_update), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((timeout_update) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (timeout_update) + 0; double _d = _Generic((timeout_update) + 0, float : (timeout_update) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (timeout_update) + 0; size_t _arg_size = _Generic((timeout_update), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((timeout_update) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((timeout_update) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = timeout_update; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
 28 
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 : _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 ((void *)0)
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "Waiting for %u ms", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), timeout_update); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "Waiting for %u ms", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), timeout_update); } else { log_3("%s: " "(%s): " "Waiting for %u ms", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), (log_arg_t)(timeout_update), src_level); } } while (
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); } while (0); } if (
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ) { z_log_printf_arg_checker("(%s): " "Waiting for %u ms", log_strdup(k_thread_name_get(k_current_get())), timeout_update); } } while (
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 198 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 );

  k_work_reschedule(&lldp_tx_timer, ((k_timeout_t) { .ticks = ((k_ticks_t)k_ms_to_ticks_ceil64((((timeout_update) > (0)) ? (timeout_update) : (0)))) }));
 }
}
...
static int lldp_check_iface(struct net_if *iface)
{
 if (net_if_l2(iface) != &_net_l2_ETHERNET) {
  return -
# 222 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
         2
# 222 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
               ;
 }

 if (!(net_eth_get_hw_capabilities(iface) & ETHERNET_LLDP)) {
  return -
# 226 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3
         3
# 226 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
              ;
 }
...
static int lldp_start(struct net_if *iface, uint32_t mgmt_event)
{
 ...
 if (mgmt_event == (((1UL << (31)) | (1UL << (30)) | (1 << 28) | (0x001 << 16)) | NET_EVENT_IF_CMD_DOWN)) {
 ...
 } else if (mgmt_event == (((1UL << (31)) | (1UL << (30)) | (1 << 28) | (0x001 << 16)) | NET_EVENT_IF_CMD_UP)) {
  do { if (!(1 && ((4U <= 0) || ((0 == 
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ) && (4U <= __log_level) && (4U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "(%s): " "Starting timer for iface %p" "\n", z_log_minimal_level_to_char(4U), log_strdup(k_thread_name_get(k_current_get())), iface); } while (
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); break; } if (0 & !0) { if (4U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 ((void *)0)
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 , 0, "%s: " "(%s): " "Starting timer for iface %p", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), iface); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
#pragma GCC diagnostic push
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
...
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 ((void *)0)
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 4U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%s: " "(%s): " "Starting timer for iface %p", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), iface); } else if (1) { log_string_sync(src_level, "%s: " "(%s): " "Starting timer for iface %p", (const char *)__func__ , log_strdup(k_thread_name_get(k_current_get())), iface); } else { log_3("%s: " "(%s): " "Starting timer for iface %p", (log_arg_t)((const char *)__func__), (log_arg_t)(log_strdup(k_thread_name_get(k_current_get()))), (log_arg_t)(iface), src_level); } } while (
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ); } while (0); } if (
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 ) { z_log_printf_arg_checker("(%s): " "Starting timer for iface %p", log_strdup(k_thread_name_get(k_current_get())), iface); } } while (
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
 0
# 259 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
 );
...
static void iface_cb(struct net_if *iface, void *user_data)
{
 ...
 if (net_if_flag_is_set(iface, NET_IF_UP)) {
  lldp_start(iface, (((1UL << (31)) | (1UL << (30)) | (1 << 28) | (0x001 << 16)) | NET_EVENT_IF_CMD_UP));
 }
}
...
static const struct net_lldpdu lldpdu = {
 .chassis_id = {
  .type_length = ((uint16_t) (((((LLDP_TLV_CHASSIS_ID << 9) | ((6) + 1)) >> 8) & 0xff) | ((((LLDP_TLV_CHASSIS_ID << 9) | ((6) + 1)) & 0xff) << 8)))
                               ,
  .subtype = 4,
  .value = { 0x00, 0x00, 0x5e, 0x00, 0x53, 0x8d }
 },
 .port_id = {
  .type_length = ((uint16_t) (((((LLDP_TLV_PORT_ID << 9) | ((sizeof("PORT_ID_PLACEHOLDER") - 1) + 1)) >> 8) & 0xff) | ((((LLDP_TLV_PORT_ID << 9) | ((sizeof("PORT_ID_PLACEHOLDER") - 1) + 1)) & 0xff) << 8)))
                            ,
  .subtype = 5,
  .value = "PORT_ID_PLACEHOLDER"
 },
 .ttl = {
  .type_length = ((uint16_t) (((((LLDP_TLV_TTL << 9) | (2)) >> 8) & 0xff) | ((((LLDP_TLV_TTL << 9) | (2)) & 0xff) << 8)))
                        ,
  .ttl = ((uint16_t) ((((((((30 * 4) + 1) < (65535)) ? ((30 * 4) + 1) : (65535))) >> 8) & 0xff) | (((((((30 * 4) + 1) < (65535)) ? ((30 * 4) + 1) : (65535))) & 0xff) << 8)))
 },
};
...
void net_lldp_unset_lldpdu(struct net_if *iface)
{
 net_lldp_config(iface, 
# 389 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
                       ((void *)0)
# 389 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
                           );
 net_lldp_config_optional(iface, 
# 390 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
                                ((void *)0)
# 390 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
                                    , 0);
}
...
void net_lldp_init(void)
{
 ...
 net_if_foreach(iface_cb, 
# 397 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c" 3 4
                         ((void *)0)
# 397 "/home/sebin/thesis/zephyrproject/zephyr/subsys/net/l2/ethernet/lldp/lldp.c"
                             );

 net_mgmt_init_event_callback(&cb, iface_event_handler,
         (((1UL << (31)) | (1UL << (30)) | (1 << 28) | (0x001 << 16)) | NET_EVENT_IF_CMD_UP) | (((1UL << (31)) | (1UL << (30)) | (1 << 28) | (0x001 << 16)) | NET_EVENT_IF_CMD_DOWN));

# 1 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
...
# 7 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 2
...
# 8 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 2
# 33 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
static struct k_spinlock lock;

static uint32_t last_load;
# 47 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
...
# 64 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
static volatile uint32_t overflow_cyc;
# 84 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
static uint32_t elapsed(void)
{
 uint32_t val1 = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
 uint32_t ctrl = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL;
 uint32_t val2 = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
# 104 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
 if ((ctrl & (1UL << 16U))
     || (val1 < val2)) {
...
void sys_clock_isr(void *arg)
{
 ...
 if ((1)) {
# 144 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
  dticks = (cycle_count - announced_cycles) / (sys_clock_hw_cycles_per_sec() / 10000);
  announced_cycles += dticks * (sys_clock_hw_cycles_per_sec() / 10000);
...
# 153 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 3 4
                                         _Bool 
# 153 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
                                              idle)
{
 ...
 if (1 && idle && ticks == ((k_ticks_t) -1)) {
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= ~(1UL );
  last_load = 0xff000000;
  return;
 }
 ...
 ticks = (ticks == ((k_ticks_t) -1)) ? ((0x00ffffff / (sys_clock_hw_cycles_per_sec() / 10000)) - 1) : ticks;
 ticks = (((ticks - 1) <= (0)) ? (0) : (((ticks - 1) < ((int32_t)((0x00ffffff / (sys_clock_hw_cycles_per_sec() / 10000)) - 1))) ? (ticks - 1) : ((int32_t)((0x00ffffff / (sys_clock_hw_cycles_per_sec() / 10000)) - 1))));

 k_spinlock_key_t key = k_spin_lock(&lock);

 uint32_t pending = elapsed();

 val1 = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;
 ...
 if ((int32_t)unannounced < 0) {
  ...
  last_load = (((1024) > (((sys_clock_hw_cycles_per_sec() / 10000)/16))) ? (1024) : (((sys_clock_hw_cycles_per_sec() / 10000)/16)));
 } else {

  delay = ticks * (sys_clock_hw_cycles_per_sec() / 10000);


  delay += unannounced;
  delay =
   ((delay + (sys_clock_hw_cycles_per_sec() / 10000) - 1) / (sys_clock_hw_cycles_per_sec() / 10000)) * (sys_clock_hw_cycles_per_sec() / 10000);
  delay -= unannounced;
  delay = (((delay) > ((((1024) > (((sys_clock_hw_cycles_per_sec() / 10000)/16))) ? (1024) : (((sys_clock_hw_cycles_per_sec() / 10000)/16))))) ? (delay) : ((((1024) > (((sys_clock_hw_cycles_per_sec() / 10000)/16))) ? (1024) : (((sys_clock_hw_cycles_per_sec() / 10000)/16)))));
  if (delay > (((0x00ffffff / (sys_clock_hw_cycles_per_sec() / 10000)) - 1) * (sys_clock_hw_cycles_per_sec() / 10000))) {
   last_load = (((0x00ffffff / (sys_clock_hw_cycles_per_sec() / 10000)) - 1) * (sys_clock_hw_cycles_per_sec() / 10000));
  } else {
   last_load = delay;
  }
 }

 val2 = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL;

 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = last_load - 1;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0;
# 226 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
 if (val1 < val2) {
...
uint32_t sys_clock_elapsed(void)
{
 ...
 k_spin_unlock(&lock, key);
 return cyc / (sys_clock_hw_cycles_per_sec() / 10000);
}
...
static int sys_clock_driver_init(const struct device *dev)
{
 ...
 __NVIC_SetPriority(SysTick_IRQn, (1 + 0));
 last_load = (sys_clock_hw_cycles_per_sec() / 10000) - 1;
 overflow_cyc = 0U;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = last_load;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0;
 ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= ((1UL ) |
     (1UL << 1U) |
     (1UL << 2U));
...
static const 
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 3 4
__attribute__((__aligned__(
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
__alignof(struct init_entry)
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 3 4
))) 
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
struct init_entry __init_sys_init_sys_clock_driver_init0 
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 3 4
__attribute__((__used__)) 
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
__attribute__((__section__(".z_init_" "PRE_KERNEL_2" "0""_"))) = { .init = (sys_clock_driver_init), .dev = (
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c" 3 4
((void *)0)
# 284 "/home/sebin/thesis/zephyrproject/zephyr/drivers/timer/cortex_m_systick.c"
), }

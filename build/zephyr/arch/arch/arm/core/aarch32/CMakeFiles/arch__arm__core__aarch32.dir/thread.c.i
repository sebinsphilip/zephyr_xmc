# 1 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
# 15 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 2
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 2
...
# 18 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 2
# 56 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
void arch_new_thread(struct k_thread *thread, k_thread_stack_t *stack,
       char *stack_ptr, k_thread_entry_t entry,
       void *p1, void *p2, void *p3)
{
 struct __basic_sf *iframe;
# 73 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
 if ((thread->base.user_options & ((1UL << (1)))) != 0) {





  thread->stack_info.start += (128 - 32);
  thread->stack_info.size -= (128 - 32);
 }
 ...
 if ((thread->base.user_options & ((1UL << (1)))) != 0) {
  thread->arch.mode |= (1 << 3);
 }
# 136 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
}
...
# 142 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3 4
_Bool 
# 142 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
     use_large_guard)
{
 if (use_large_guard) {
...
{
 if (((thread->base.user_options & ((1UL << (1)))) != 0) ||
  ((thread->arch.mode_exc_return & (0x00000010UL)) == 0)) {
# 209 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
  ((FPU_Type *) ((0xE000E000UL) + 0x0F30UL) )->FPCCR |= (1UL << 30U);

  z_arm_thread_stack_info_adjust(thread, 
# 211 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3 4
                                        1
# 211 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
                                            );
 ...
 z_arm_thread_stack_info_adjust(thread, 
# 226 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3 4
                                       0
# 226 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
                                            );

 return 32;
}
# 378 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
uint32_t z_check_thread_stack_fail(const uint32_t fault_addr, const uint32_t psp)
{

 const struct k_thread *thread = _kernel.cpus[0].current;

 if (thread == 
# 383 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3 4
              ((void *)0)
# 383 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
                  ) {
  return 0;
 }
 ...
 uint32_t guard_len =
  ((_kernel.cpus[0].current->arch.mode & (1 << 3)) != 0) ?
  128 : 32;
# 431 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
 if (((fault_addr != -
# 431 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3
    22
# 431 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
    ) ? ((fault_addr >= thread->stack_info.start - guard_len) && (fault_addr < (thread->stack_info.start - guard_len + guard_len)) && (psp < (thread->stack_info.start - guard_len + guard_len))) : (psp < (thread->stack_info.start - guard_len + guard_len)))

                   ) {

  return thread->stack_info.start;
 }
# 447 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
 return 0;
}
...
int arch_float_disable(struct k_thread *thread)
{
 if (thread != _kernel.cpus[0].current) {
  return -
# 455 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3
         22
# 455 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
               ;
 }

 if (arch_is_in_isr()) {
  return -
# 459 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3
         22
# 459 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
               ;
 }
# 469 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
...
int arch_float_enable(struct k_thread *thread, unsigned int options)
{
 ...
 return -
# 487 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c" 3
        134
# 487 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
               ;
}
...
# 541 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
 z_arm_configure_dynamic_mpu_regions(main_thread);
# 557 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/thread.c"
 __asm__ volatile (
 "mov   r0,  %0\n\t"

# 1 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
# 15 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 2
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 2
...
# 11 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_msg.h"
...
# 18 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 2
...
# 18 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
((void *)0)
# 18 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
{
 do { if (!(1 && ((1U <= 0) || ((0 == 
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
((void *)0)
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
, 0, "r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x", esf->basic.a1, esf->basic.a2, esf->basic.a3); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
#pragma GCC diagnostic push
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0))) > (1)) ? (_Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0; size_t _arg_size = _Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0; double _d = _Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, float : ("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0; size_t _arg_size = _Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.a1) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.a1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a1) + 0))) > (1)) ? (_Generic((esf->basic.a1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a1) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.a1) + 0; size_t _arg_size = _Generic((esf->basic.a1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.a1) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.a1) + 0; double _d = _Generic((esf->basic.a1) + 0, float : (esf->basic.a1) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.a1) + 0; size_t _arg_size = _Generic((esf->basic.a1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.a1) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.a1) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.a1; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.a2) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.a2) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a2) + 0))) > (1)) ? (_Generic((esf->basic.a2) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a2) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.a2) + 0; size_t _arg_size = _Generic((esf->basic.a2), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.a2) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.a2) + 0; double _d = _Generic((esf->basic.a2) + 0, float : (esf->basic.a2) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.a2) + 0; size_t _arg_size = _Generic((esf->basic.a2), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.a2) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.a2) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.a2; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.a3) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.a3) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a3) + 0))) > (1)) ? (_Generic((esf->basic.a3) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a3) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.a3) + 0; size_t _arg_size = _Generic((esf->basic.a3), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.a3) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.a3) + 0; double _d = _Generic((esf->basic.a3) + 0, float : (esf->basic.a3) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.a3) + 0; size_t _arg_size = _Generic((esf->basic.a3), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.a3) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.a3) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.a3; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28 
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
((void *)0)
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 1U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x", esf->basic.a1, esf->basic.a2, esf->basic.a3); } else if (1) { log_string_sync(src_level, "r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x", esf->basic.a1, esf->basic.a2, esf->basic.a3); } else { log_3("r0/a1:  0x%08x  r1/a2:  0x%08x  r2/a3:  0x%08x", (log_arg_t)(esf->basic.a1), (log_arg_t)(esf->basic.a2), (log_arg_t)(esf->basic.a3), src_level); } } while (
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); } if (
...
# 22 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
                                              ...
                                              ;
 do { if (!(1 && ((1U <= 0) || ((0 == 
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
#pragma GCC diagnostic ignored "-Wpointer-arith"
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 int _rv = (((_Generic((esf->basic.a4) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((esf->basic.ip) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((esf->basic.lr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) - 0) > 0);
#pragma GCC diagnostic pop
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 _rv; })) { ; z_log_msg2_runtime_create(0, (void *)_src, 1U, (uint8_t *)
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
((void *)0)
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
, 0, "r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x", esf->basic.a4, esf->basic.ip, esf->basic.lr); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
#pragma GCC diagnostic push
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0))) > (1)) ? (_Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0; size_t _arg_size = _Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0; double _d = _Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, float : ("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0; size_t _arg_size = _Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.a4) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.a4) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a4) + 0))) > (1)) ? (_Generic((esf->basic.a4) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.a4) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.a4) + 0; size_t _arg_size = _Generic((esf->basic.a4), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.a4) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.a4) + 0; double _d = _Generic((esf->basic.a4) + 0, float : (esf->basic.a4) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.a4) + 0; size_t _arg_size = _Generic((esf->basic.a4), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.a4) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.a4) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.a4; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.ip) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.ip) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.ip) + 0))) > (1)) ? (_Generic((esf->basic.ip) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.ip) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.ip) + 0; size_t _arg_size = _Generic((esf->basic.ip), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.ip) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.ip) + 0; double _d = _Generic((esf->basic.ip) + 0, float : (esf->basic.ip) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.ip) + 0; size_t _arg_size = _Generic((esf->basic.ip), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.ip) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.ip) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.ip; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.lr) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.lr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.lr) + 0))) > (1)) ? (_Generic((esf->basic.lr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.lr) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.lr) + 0; size_t _arg_size = _Generic((esf->basic.lr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.lr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.lr) + 0; double _d = _Generic((esf->basic.lr) + 0, float : (esf->basic.lr) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.lr) + 0; size_t _arg_size = _Generic((esf->basic.lr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.lr) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.lr) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.lr; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28 
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
: _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
((void *)0)
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 1U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x", esf->basic.a4, esf->basic.ip, esf->basic.lr); } else if (1) { log_string_sync(src_level, "r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x", esf->basic.a4, esf->basic.ip, esf->basic.lr); } else { log_3("r3/a4:  0x%08x r12/ip:  0x%08x r14/lr:  0x%08x", (log_arg_t)(esf->basic.a4), (log_arg_t)(esf->basic.ip), (log_arg_t)(esf->basic.lr), src_level); } } while (
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); } if (
...
# 24 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
                                              ...
                                              ;
 do { if (!(1 && ((1U <= 0) || ((0 == 
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
#pragma GCC diagnostic ignored "-Wpointer-arith"
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 int _rv = (((_Generic((esf->basic.xpsr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) - 0) > 0);
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
#pragma GCC diagnostic pop
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 _rv; })) { ; z_log_msg2_runtime_create(0, (void *)_src, 1U, (uint8_t *)
...
((void *)0)
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
, 0, " xpsr:  0x%08x", esf->basic.xpsr); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
#pragma GCC diagnostic push
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((" xpsr:  0x%08x") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((" xpsr:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((" xpsr:  0x%08x") + 0))) > (1)) ? (_Generic((" xpsr:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((" xpsr:  0x%08x") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (" xpsr:  0x%08x") + 0; size_t _arg_size = _Generic((" xpsr:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((" xpsr:  0x%08x") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (" xpsr:  0x%08x") + 0; double _d = _Generic((" xpsr:  0x%08x") + 0, float : (" xpsr:  0x%08x") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (" xpsr:  0x%08x") + 0; size_t _arg_size = _Generic((" xpsr:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((" xpsr:  0x%08x") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((" xpsr:  0x%08x") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = " xpsr:  0x%08x"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.xpsr) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.xpsr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.xpsr) + 0))) > (1)) ? (_Generic((esf->basic.xpsr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.xpsr) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.xpsr) + 0; size_t _arg_size = _Generic((esf->basic.xpsr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.xpsr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.xpsr) + 0; double _d = _Generic((esf->basic.xpsr) + 0, float : (esf->basic.xpsr) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.xpsr) + 0; size_t _arg_size = _Generic((esf->basic.xpsr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.xpsr) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.xpsr) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.xpsr; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28 
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
: _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
((void *)0)
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 1U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, " xpsr:  0x%08x", esf->basic.xpsr); } else if (1) { log_string_sync(src_level, " xpsr:  0x%08x", esf->basic.xpsr); } else { log_1(" xpsr:  0x%08x", (log_arg_t)(esf->basic.xpsr), src_level); } } while (
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); } if (
...
# 26 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ...
 for (int i = 0; i < ((long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(esf->s), __typeof__(&(esf->s)[0])))]) - 1) + (sizeof(esf->s) / sizeof((esf->s)[0])))); i += 4) {
  do { if (!(1 && ((1U <= 0) || ((0 == 
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 0
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ) && (1U <= __log_level) && (1U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x" "\n", z_log_minimal_level_to_char(1U), i, (uint32_t)esf->s[i], i + 1, (uint32_t)esf->s[i + 1], i + 2, (uint32_t)esf->s[i + 2], i + 3, (uint32_t)esf->s[i + 3]); } while (
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 0
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ); break; } if (0 & !0) { if (1U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic ignored "-Wpointer-arith"
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
  int _rv = (((_Generic((i) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic(((uint32_t)esf->s[i]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((i + 1) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic(((uint32_t)esf->s[i + 1]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((i + 2) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic(((uint32_t)esf->s[i + 2]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic((i + 3) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0) + _Generic(((uint32_t)esf->s[i + 3]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) - 0) > 0);
...
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 ((void *)0)
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 , 0, "s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x", i, (uint32_t)esf->s[i], i + 1, (uint32_t)esf->s[i + 1], i + 2, (uint32_t)esf->s[i + 2], i + 3, (uint32_t)esf->s[i + 3]); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
...
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
 28
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0))) > (1)) ? (_Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0; size_t _arg_size = _Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0; double _d = _Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, float : ("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0; size_t _arg_size = _Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((i) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((i) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i) + 0))) > (1)) ? (_Generic((i) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (i) + 0; size_t _arg_size = _Generic((i), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((i) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (i) + 0; double _d = _Generic((i) + 0, float : (i) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (i) + 0; size_t _arg_size = _Generic((i), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((i) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((i) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = i; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((uint32_t)esf->s[i]) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((uint32_t)esf->s[i]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i]) + 0))) > (1)) ? (_Generic(((uint32_t)esf->s[i]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i]) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((uint32_t)esf->s[i]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((uint32_t)esf->s[i]) + 0; double _d = _Generic(((uint32_t)esf->s[i]) + 0, float : ((uint32_t)esf->s[i]) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((uint32_t)esf->s[i]) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((uint32_t)esf->s[i]) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (uint32_t)esf->s[i]; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((i + 1) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((i + 1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i + 1) + 0))) > (1)) ? (_Generic((i + 1) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i + 1) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (i + 1) + 0; size_t _arg_size = _Generic((i + 1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((i + 1) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (i + 1) + 0; double _d = _Generic((i + 1) + 0, float : (i + 1) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (i + 1) + 0; size_t _arg_size = _Generic((i + 1), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((i + 1) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((i + 1) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = i + 1; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((uint32_t)esf->s[i + 1]) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((uint32_t)esf->s[i + 1]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i + 1]) + 0))) > (1)) ? (_Generic(((uint32_t)esf->s[i + 1]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i + 1]) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i + 1]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i + 1]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((uint32_t)esf->s[i + 1]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((uint32_t)esf->s[i + 1]) + 0; double _d = _Generic(((uint32_t)esf->s[i + 1]) + 0, float : ((uint32_t)esf->s[i + 1]) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i + 1]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i + 1]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((uint32_t)esf->s[i + 1]) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((uint32_t)esf->s[i + 1]) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (uint32_t)esf->s[i + 1]; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((i + 2) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((i + 2) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i + 2) + 0))) > (1)) ? (_Generic((i + 2) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i + 2) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (i + 2) + 0; size_t _arg_size = _Generic((i + 2), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((i + 2) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (i + 2) + 0; double _d = _Generic((i + 2) + 0, float : (i + 2) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (i + 2) + 0; size_t _arg_size = _Generic((i + 2), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((i + 2) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((i + 2) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = i + 2; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((uint32_t)esf->s[i + 2]) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((uint32_t)esf->s[i + 2]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i + 2]) + 0))) > (1)) ? (_Generic(((uint32_t)esf->s[i + 2]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i + 2]) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i + 2]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i + 2]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((uint32_t)esf->s[i + 2]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((uint32_t)esf->s[i + 2]) + 0; double _d = _Generic(((uint32_t)esf->s[i + 2]) + 0, float : ((uint32_t)esf->s[i + 2]) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i + 2]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i + 2]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((uint32_t)esf->s[i + 2]) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((uint32_t)esf->s[i + 2]) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (uint32_t)esf->s[i + 2]; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((i + 3) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((i + 3) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i + 3) + 0))) > (1)) ? (_Generic((i + 3) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((i + 3) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (i + 3) + 0; size_t _arg_size = _Generic((i + 3), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((i + 3) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (i + 3) + 0; double _d = _Generic((i + 3) + 0, float : (i + 3) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (i + 3) + 0; size_t _arg_size = _Generic((i + 3), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((i + 3) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((i + 3) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = i + 3; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(((uint32_t)esf->s[i + 3]) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(((uint32_t)esf->s[i + 3]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i + 3]) + 0))) > (1)) ? (_Generic(((uint32_t)esf->s[i + 3]) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(((uint32_t)esf->s[i + 3]) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i + 3]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i + 3]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(((uint32_t)esf->s[i + 3]) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ((uint32_t)esf->s[i + 3]) + 0; double _d = _Generic(((uint32_t)esf->s[i + 3]) + 0, float : ((uint32_t)esf->s[i + 3]) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ((uint32_t)esf->s[i + 3]) + 0; size_t _arg_size = _Generic(((uint32_t)esf->s[i + 3]), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(((uint32_t)esf->s[i + 3]) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(((uint32_t)esf->s[i + 3]) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = (uint32_t)esf->s[i + 3]; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
 28 
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 : _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 ((void *)0)
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 1U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x", i, (uint32_t)esf->s[i], i + 1, (uint32_t)esf->s[i + 1], i + 2, (uint32_t)esf->s[i + 2], i + 3, (uint32_t)esf->s[i + 3]); } else if (1) { log_string_sync(src_level, "s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x", i, (uint32_t)esf->s[i], i + 1, (uint32_t)esf->s[i + 1], i + 2, (uint32_t)esf->s[i + 2], i + 3, (uint32_t)esf->s[i + 3]); } else { do { log_arg_t args[] = {(log_arg_t)(i) , (log_arg_t)((uint32_t)esf->s[i]) , (log_arg_t)(i + 1) , (log_arg_t)((uint32_t)esf->s[i + 1]) , (log_arg_t)(i + 2) , (log_arg_t)((uint32_t)esf->s[i + 2]) , (log_arg_t)(i + 3) , (log_arg_t)((uint32_t)esf->s[i + 3])}; log_n("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x", args, ((long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(args), __typeof__(&(args)[0])))]) - 1) + (sizeof(args) / sizeof((args)[0])))), src_level); } while (
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 0
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ); } } while (
...
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 0
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 ) { z_log_printf_arg_checker("s[%2d]:  0x%08x  s[%2d]:  0x%08x" "  s[%2d]:  0x%08x  s[%2d]:  0x%08x", i, (uint32_t)esf->s[i], i + 1, (uint32_t)esf->s[i + 1], i + 2, (uint32_t)esf->s[i + 2], i + 3, (uint32_t)esf->s[i + 3]); } } while (
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
 0
# 29 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 )
 ...
 do { if (!(1 && ((1U <= 0) || ((0 == 
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
) && (1U <= __log_level) && (1U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "fpscr:  0x%08x" "\n", z_log_minimal_level_to_char(1U), esf->fpscr); } while (
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); break; } if (0 & !0) { if (1U > ((struct log_source_const_data *)__log_current_const_data)->level) { break; } } 
...
#pragma GCC diagnostic ignored "-Wpointer-arith"
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 int _rv = (((_Generic((esf->fpscr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) - 0) > 0);
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
#pragma GCC diagnostic pop
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 _rv; })) { ; z_log_msg2_runtime_create(0, (void *)_src, 1U, (uint8_t *)
...
((void *)0)
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
, 0, "fpscr:  0x%08x", esf->fpscr); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
#pragma GCC diagnostic push
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("fpscr:  0x%08x") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("fpscr:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("fpscr:  0x%08x") + 0))) > (1)) ? (_Generic(("fpscr:  0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("fpscr:  0x%08x") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("fpscr:  0x%08x") + 0; size_t _arg_size = _Generic(("fpscr:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("fpscr:  0x%08x") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("fpscr:  0x%08x") + 0; double _d = _Generic(("fpscr:  0x%08x") + 0, float : ("fpscr:  0x%08x") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("fpscr:  0x%08x") + 0; size_t _arg_size = _Generic(("fpscr:  0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("fpscr:  0x%08x") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("fpscr:  0x%08x") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "fpscr:  0x%08x"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->fpscr) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->fpscr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->fpscr) + 0))) > (1)) ? (_Generic((esf->fpscr) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->fpscr) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->fpscr) + 0; size_t _arg_size = _Generic((esf->fpscr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->fpscr) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->fpscr) + 0; double _d = _Generic((esf->fpscr) + 0, float : (esf->fpscr) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->fpscr) + 0; size_t _arg_size = _Generic((esf->fpscr), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->fpscr) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->fpscr) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->fpscr; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28 
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
: _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
((void *)0)
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 1U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "fpscr:  0x%08x", esf->fpscr); } else if (1) { log_string_sync(src_level, "fpscr:  0x%08x", esf->fpscr); } else { log_1("fpscr:  0x%08x", (log_arg_t)(esf->fpscr), src_level); } } while (
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); } if (
...
0
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
) { z_log_printf_arg_checker("fpscr:  0x%08x", esf->fpscr); } } while (
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 36 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
);
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 do { if (!(1 && ((1U <= 0) || ((0 == 
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
#pragma GCC diagnostic ignored "-Wpointer-arith"
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 int _rv = (((_Generic((esf->basic.pc) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) - 0) > 0);
#pragma GCC diagnostic pop
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 _rv; })) { ; z_log_msg2_runtime_create(0, (void *)_src, 1U, (uint8_t *)
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
((void *)0)
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
, 0, "Faulting instruction address (r15/pc): 0x%08x", esf->basic.pc); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
#pragma GCC diagnostic push
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
...
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Faulting instruction address (r15/pc): 0x%08x") + 0))) > (1)) ? (_Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("Faulting instruction address (r15/pc): 0x%08x") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("Faulting instruction address (r15/pc): 0x%08x") + 0; size_t _arg_size = _Generic(("Faulting instruction address (r15/pc): 0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("Faulting instruction address (r15/pc): 0x%08x") + 0; double _d = _Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, float : ("Faulting instruction address (r15/pc): 0x%08x") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("Faulting instruction address (r15/pc): 0x%08x") + 0; size_t _arg_size = _Generic(("Faulting instruction address (r15/pc): 0x%08x"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("Faulting instruction address (r15/pc): 0x%08x") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "Faulting instruction address (r15/pc): 0x%08x"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((esf->basic.pc) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((esf->basic.pc) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.pc) + 0))) > (1)) ? (_Generic((esf->basic.pc) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((esf->basic.pc) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (esf->basic.pc) + 0; size_t _arg_size = _Generic((esf->basic.pc), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((esf->basic.pc) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (esf->basic.pc) + 0; double _d = _Generic((esf->basic.pc) + 0, float : (esf->basic.pc) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (esf->basic.pc) + 0; size_t _arg_size = _Generic((esf->basic.pc), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((esf->basic.pc) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((esf->basic.pc) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = esf->basic.pc; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3
28 
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
: _total_len; if (_pbuf) { union z_cbprintf_hdr hdr = { .desc = { .len = (uint8_t)(_pkg_len / sizeof(int)), .str_cnt = 0, .ro_str_cnt = str_idxs ? _s_cnt : (uint8_t)0, } }; *_len_loc = hdr; }
...
((void *)0)
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 1U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "Faulting instruction address (r15/pc): 0x%08x", esf->basic.pc); } else if (1) { log_string_sync(src_level, "Faulting instruction address (r15/pc): 0x%08x", esf->basic.pc); } else { log_1("Faulting instruction address (r15/pc): 0x%08x", (log_arg_t)(esf->basic.pc), src_level); } } while (
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
0
# 53 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
); } while (0); } if (
...
void z_arm_fatal_error(unsigned int reason, const z_arch_esf_t *esf)
{
 ...
 if (esf != 
# 60 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c" 3 4
           ((void *)0)
# 60 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
               ) {
  esf_dump(esf);
 }
 z_fatal_error(reason, esf);
}
# 81 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
void z_do_kernel_oops(const z_arch_esf_t *esf)
{

 unsigned int reason = esf->basic.r0;
# 104 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
 z_arm_fatal_error(reason, esf);
# 116 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/core/aarch32/fatal.c"
}

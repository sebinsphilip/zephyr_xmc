# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
...
# 8 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 2
...
# 10 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 2
...
# 11 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 2
...
# 12 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/syscall_handler.h" 1
# 13 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 2
...
{
 struct k_timer *timer = ((struct k_timer *)(((char *)(t)) - 
# 25 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
                        __builtin_offsetof (
# 25 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
                        struct k_timer
# 25 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
                        , 
# 25 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
...
# 25 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
 ...
 if (timer->expiry_fn != 
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
                        ((void *)0)
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
                            ) {
 ...
 if (thread == 
# 57 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
              ((void *)0)
# 57 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
                  ) {
  k_spin_unlock(&lock, key);
  return;
 }
    ...
    k_timer_stop_t stop_fn)
{
 ...
 do { } while (
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
0
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
);

 timer->user_data = 
# 88 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
                   ((void *)0)
# 88 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
                       ;
...
{
 do { } while (
# 97 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
0
# 97 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
);

 if (((duration).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks)) {
  return;
 }
# 116 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
 if (!((period).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks) && period.ticks != 0 &&
     (((k_ticks_t) -1) - 1 - (period.ticks)) < 0) {
  period.ticks = (((period.ticks - 1) > (1)) ? (period.ticks - 1) : (1));
 }
...
# 143 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
void z_impl_k_timer_stop(struct k_timer *timer)
{
 do { } while (
# 145 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
0
# 145 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
);
 ...
 if (timer->stop_fn != 
# 153 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
                      ((void *)0)
# 153 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
                          ) {
  timer->stop_fn(timer);
 }
 ...
 if (1) {
  ...
  if (pending_thread != 
# 160 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
                       ((void *)0)
# 160 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
                           ) {
...
# 176 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
...
# 196 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
uint32_t z_impl_k_timer_status_sync(struct k_timer *timer)
{
 { };
 do { } while (
# 199 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
0
# 199 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
);
...
# 219 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
          1
# 219 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
              );
 ...
 if (result == 0U) {
  if (!z_is_inactive_timeout(&timer->timeout)) {
   do { } while (
# 229 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
  0
# 229 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
  );
 ...
 do { } while (
# 250 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c" 3 4
0
# 250 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timer.c"
);

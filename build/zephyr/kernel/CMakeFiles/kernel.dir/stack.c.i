# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
# 11 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
...
# 12 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 2
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 2
...
# 17 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/sys/check.h" 1
# 18 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 2
...
# 19 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/syscall_handler.h" 1
# 20 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 2
    ...
    uint32_t num_entries)
{
 ...
 do { } while (
# 30 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 30 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);
 z_object_init(stack);
}
...
int32_t z_impl_k_stack_alloc_init(struct k_stack *stack, uint32_t num_entries)
{
 ...
 do { } while (
# 39 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 39 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

 buffer = z_thread_malloc(num_entries * sizeof(stack_data_t));
 if (buffer != 
# 42 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
              ((void *)0)
# 42 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
                  ) {
  ...
  ret = -
# 47 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3
        12
# 47 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
              ;
 }

 do { } while (
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

 return ret;
}
# 66 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
int k_stack_cleanup(struct k_stack *stack)
{
 do { } while (
# 68 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 68 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

 if (z_waitq_head(&stack->wait_q) != 
# 70 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
((void *)0)
# 70 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
) {
  do { } while (
# 71 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
 0
# 71 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
 );

  return -
# 73 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3
         11
# 73 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
               ;
 }
 ...
 if ((stack->flags & ((uint8_t)1)) != (uint8_t)0) {
  k_free(stack->base);
  stack->base = 
# 78 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
               ((void *)0)
# 78 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
                   ;
  stack->flags &= ~((uint8_t)1);
 }

 do { } while (
# 82 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 82 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);
...
int z_impl_k_stack_push(struct k_stack *stack, stack_data_t data)
{
 ...
 do { } while (
# 93 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 93 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

 if (stack->next == stack->top) {
  ret = -
# 96 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3
        12
# 96 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
              ;
  goto out;
 }
...
# 102 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
                            ((void *)0)
# 102 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
                                ) {
...
out:
 ...
 do { } while (
# 119 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 119 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

 return ret;
}
# 134 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
         ...
         k_timeout_t timeout)
{
 ...
 do { } while (
# 142 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 142 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

 if (__builtin_expect((
# 144 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
    _Bool
# 144 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
...
# 144 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
  ...
  *data = *(stack->next);
  ...
  do { } while (
# 149 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
 0
# 149 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
 );
 ...
 do { } while (
# 154 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 154 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);
 ...
 if (((timeout).ticks == (((k_timeout_t) {0})).ticks)) {
  ...
  do { } while (
# 159 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
 0
# 159 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
 );

  return -
# 161 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3
         16
# 161 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
              ;
 }

 result = z_pend_curr(&stack->lock, key, &stack->wait_q, timeout);
 if (result == -
# 165 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3
               11
# 165 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
                     ) {
  do { } while (
# 166 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
 0
# 166 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
 );

  return -
# 168 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3
         11
# 168 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
               ;
 }
 ...
 *data = (stack_data_t)_kernel.cpus[0].current->base.swap_data;
 ...
 do { } while (
# 173 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c" 3 4
0
# 173 "/home/sebin/thesis/zephyrproject/zephyr/kernel/stack.c"
);

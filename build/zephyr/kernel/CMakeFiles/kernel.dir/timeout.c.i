# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
...
# 8 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 2
...
# 10 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 2

# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/syscall_handler.h" 1
# 12 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 2
...
# 13 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 2
...
# 39 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
static struct _timeout *first(void)
{
 sys_dnode_t *t = sys_dlist_peek_head(&timeout_list);

 return t == 
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
            ((void *)0) 
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                 ? 
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                   ((void *)0) 
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                        : ((struct _timeout *)(((char *)(t)) - 
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                          __builtin_offsetof (
# 43 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                          struct _timeout
...
static struct _timeout *next(struct _timeout *t)
{
 ...
 return n == 
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
            ((void *)0) 
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                 ? 
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                   ((void *)0) 
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                        : ((struct _timeout *)(((char *)(n)) - 
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                          __builtin_offsetof (
# 50 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                          struct _timeout
...
{
 if (next(t) != 
# 55 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
               ((void *)0)
# 55 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                   ) {
...
static int32_t next_timeout(void)
{
 ...
 int32_t ret = to == 
# 71 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                    ((void *)0) 
# 71 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                         ? (0 ? ((k_ticks_t) -1) : 0x7fffffff)
  : (((to->dticks - ticks_elapsed) <= (0)) ? (0) : (((to->dticks - ticks_elapsed) < ((0 ? ((k_ticks_t) -1) : 0x7fffffff))) ? (to->dticks - ticks_elapsed) : ((0 ? ((k_ticks_t) -1) : 0x7fffffff))));


 if ((&_kernel.cpus[0])->slice_ticks && (&_kernel.cpus[0])->slice_ticks < ret) {
  ret = (&_kernel.cpus[0])->slice_ticks;
 }
     ...
     k_timeout_t timeout)
{
 ...
 for (k_spinlock_key_t __i = {}, __key = k_spin_lock(&timeout_lock); !__i.key; k_spin_unlock(&timeout_lock, __key), __i.key = 1) {
  ...
  for (t = first(); t != 
# 108 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                        ((void *)0)
# 108 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                            ; t = next(t)) {
  ...
  if (t == 
# 117 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
          ((void *)0)
# 117 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
              ) {
   sys_dlist_append(&timeout_list, &to->node);
  }

  if (to == first()) {
# 131 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
   int32_t next_time = next_timeout();

   if (next_time == 0 ||
       (&_kernel.cpus[0])->slice_ticks != next_time) {
    sys_clock_set_timeout(next_time, 
# 135 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                                    0
# 135 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                                         );
   }
...
{
 int ret = -
# 146 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3
           22
# 146 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                 ;
...
# 167 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                                        ((void *)0)
# 167 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                                            ; t = next(t)) {
  ticks += t->dticks;
  if (timeout == t) {
   break;
...
void z_set_timeout_expiry(int32_t ticks, 
# 209 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                                        _Bool 
# 209 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                                             is_idle)
{
 for (k_spinlock_key_t __i = {}, __key = k_spin_lock(&timeout_lock); !__i.key; k_spin_unlock(&timeout_lock, __key), __i.key = 1) {
  int next_to = next_timeout();
  
# 213 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
 _Bool 
# 213 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
      sooner = (next_to == ((k_ticks_t) -1))
         || (ticks <= next_to);
  
# 215 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
 _Bool 
# 215 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
      imminent = next_to <= 1;
# 227 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
  if (!imminent && (sooner || 0)) {
   sys_clock_set_timeout((((ticks) < (next_to)) ? (ticks) : (next_to)), is_idle);
  }
 }
}
...
void sys_clock_announce(int32_t ticks)
{
 ...
 while (first() != 
# 243 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                  ((void *)0) 
# 243 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
 ...
 if (first() != 
# 257 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
               ((void *)0)
# 257 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                   ) {
  first()->dticks -= announce_remaining;
 }
...
# 264 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
                                      0
# 264 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
                                           );
...
# 301 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
void z_impl_k_busy_wait(uint32_t usec_to_wait)
{
 do { } while (
# 303 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
0
# 303 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
);
 if (usec_to_wait == 0U) {
  do { } while (
# 305 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
 0
# 305 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
 );
  return;
 }
 ...
 do { } while (
# 330 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c" 3 4
0
# 330 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
);
}
# 346 "/home/sebin/thesis/zephyrproject/zephyr/kernel/timeout.c"
uint64_t sys_clock_timeout_end_calc(k_timeout_t timeout)
{
 k_ticks_t dt;
 ...
 if (((timeout).ticks == (((k_timeout_t) { .ticks = (((k_ticks_t) -1)) })).ticks)) {
  ...
  if (1 && (((k_ticks_t) -1) - 1 - (dt)) >= 0) {
   return (((k_ticks_t) -1) - 1 - (dt));
  }
  return sys_clock_tick_get() + (((1) > (dt)) ? (1) : (dt));
 }
}

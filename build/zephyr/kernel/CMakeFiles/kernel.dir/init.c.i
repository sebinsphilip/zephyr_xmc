# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
# 14 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 15 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/offsets_short.h" 1
# 10 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/offsets_short.h"
# 1 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/offsets.h" 1
# 11 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/offsets_short.h" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/include/offsets_short_arch.h" 1
# 10 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/include/offsets_short_arch.h"
# 1 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/include/aarch32/offsets_short_arch.h" 1
# 11 "/home/sebin/thesis/zephyrproject/zephyr/arch/arm/include/offsets_short_arch.h" 2
# 12 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/offsets_short.h" 2
# 16 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2


# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 1
# 15 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
...
# 16 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 2
...
# 23 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
((void *)0)
# 23 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
...
; static const uint32_t __log_level __attribute__((__unused__)) = 3;
 ...
 if (k_thread_stack_space_get(thread, &unused) == 0) {
  ...
  if (tname == 
# 30 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
              ((void *)0)
# 30 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
                  ) {
   tname = "unknown";
  }

  do { if (!(1 && ((3U <= 0) || ((0 == 
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 0
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 ) && (3U <= __log_level) && (3U <= 4) ) ))) { break; } if (0) { do { z_log_minimal_printk("%c: " "%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)" "\n", z_log_minimal_level_to_char(3U), thread, log_strdup(tname), unused, size - unused, size, pcnt); } while (
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 0
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
...
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 ((void *)0)
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 , 0, "%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)", thread, log_strdup(tname), unused, size - unused, size, pcnt); _mode = Z_LOG_MSG2_MODE_RUNTIME; } else { do { int _plen; do {
...
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3
 28
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 ; break; } _len_loc = (union z_cbprintf_hdr *)_pbuf; _pkg_len += sizeof(union z_cbprintf_hdr); _pkg_offset += sizeof(union z_cbprintf_hdr); do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0))) > (1)) ? (_Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = ("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0; size_t _arg_size = _Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = ("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0; double _d = _Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, float : ("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = ("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0; size_t _arg_size = _Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)"), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, float : &_d, default : &_v), _wsize); } else { *_Generic(("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)") + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = "%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)"; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((thread) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((thread) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((thread) + 0))) > (1)) ? (_Generic((thread) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((thread) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (thread) + 0; size_t _arg_size = _Generic((thread), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((thread) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (thread) + 0; double _d = _Generic((thread) + 0, float : (thread) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (thread) + 0; size_t _arg_size = _Generic((thread), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((thread) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((thread) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = thread; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((log_strdup(tname)) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((log_strdup(tname)) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(tname)) + 0))) > (1)) ? (_Generic((log_strdup(tname)) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((log_strdup(tname)) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (log_strdup(tname)) + 0; size_t _arg_size = _Generic((log_strdup(tname)), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((log_strdup(tname)) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (log_strdup(tname)) + 0; double _d = _Generic((log_strdup(tname)) + 0, float : (log_strdup(tname)) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (log_strdup(tname)) + 0; size_t _arg_size = _Generic((log_strdup(tname)), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((log_strdup(tname)) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((log_strdup(tname)) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = log_strdup(tname); } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((unused) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((unused) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((unused) + 0))) > (1)) ? (_Generic((unused) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((unused) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (unused) + 0; size_t _arg_size = _Generic((unused), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((unused) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (unused) + 0; double _d = _Generic((unused) + 0, float : (unused) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (unused) + 0; size_t _arg_size = _Generic((unused), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((unused) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((unused) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = unused; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((size - unused) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((size - unused) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((size - unused) + 0))) > (1)) ? (_Generic((size - unused) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((size - unused) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (size - unused) + 0; size_t _arg_size = _Generic((size - unused), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((size - unused) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (size - unused) + 0; double _d = _Generic((size - unused) + 0, float : (size - unused) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (size - unused) + 0; size_t _arg_size = _Generic((size - unused), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((size - unused) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((size - unused) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = size - unused; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((size) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((size) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((size) + 0))) > (1)) ? (_Generic((size) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((size) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (size) + 0; size_t _arg_size = _Generic((size), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((size) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (size) + 0; double _d = _Generic((size) + 0, float : (size) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (size) + 0; size_t _arg_size = _Generic((size), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((size) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((size) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = size; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0) ; do { _Static_assert(!((sizeof(double) < (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double)))) && _Generic((pcnt) + 0, long double : 1, default : 0) && !0), "" "Packaging of long double not enabled in Kconfig."); while (_pkg_offset % (((_Generic((pcnt) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((pcnt) + 0))) > (1)) ? (_Generic((pcnt) + 0, float : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), double : (((1) > (__alignof__(double))) ? (1) : (__alignof__(double))), long double : (((1) > (__alignof__(long double))) ? (1) : (__alignof__(long double))), long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), unsigned long long : (((1) > (__alignof__(long long))) ? (1) : (__alignof__(long long))), default : __alignof__((pcnt) + 0))) : (1))) { _pkg_len += sizeof(int); _pkg_offset += sizeof(int); } uint32_t _arg_size = ({ __auto_type _v = (pcnt) + 0; size_t _arg_size = _Generic((pcnt), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); if (_Generic((pcnt) + 0, char * : 1, const char * : (0 & (1UL << (0))) ? 0 : 1, volatile char * : 1, const volatile char * : 1, wchar_t * : 1, const wchar_t * : (0 & (1UL << (0))) ? 0 : 1, volatile wchar_t * : 1, const volatile wchar_t * : 1, default : 0)) { _s_buffer[_s_cnt++] = _pkg_len / sizeof(int); } if (_pbuf && _pkg_len < (int)_pmax) { do { if (0) { __auto_type _v = (pcnt) + 0; double _d = _Generic((pcnt) + 0, float : (pcnt) + 0, default : 0.0); size_t arg_size = ({ __auto_type _v = (pcnt) + 0; size_t _arg_size = _Generic((pcnt), float : sizeof(double), default : sizeof((_v)) ); _arg_size; }); size_t _wsize = arg_size / sizeof(int); z_cbprintf_wcpy((int *)&_pbuf[_pkg_len], (int *) _Generic((pcnt) + 0, float : &_d, default : &_v), _wsize); } else { *_Generic((pcnt) + 0, char : (int *)&_pbuf[_pkg_len], unsigned char: (int *)&_pbuf[_pkg_len], short : (int *)&_pbuf[_pkg_len], unsigned short : (int *)&_pbuf[_pkg_len], int : (int *)&_pbuf[_pkg_len], unsigned int : (unsigned int *)&_pbuf[_pkg_len], long : (long *)&_pbuf[_pkg_len], unsigned long : (unsigned long *)&_pbuf[_pkg_len], long long : (long long *)&_pbuf[_pkg_len], unsigned long long : (unsigned long long *)&_pbuf[_pkg_len], float : (double *)&_pbuf[_pkg_len], double : (double *)&_pbuf[_pkg_len], long double : (long double *)&_pbuf[_pkg_len], default : (const void **)&_pbuf[_pkg_len]) = pcnt; } } while (0); } _pkg_len += _arg_size; _pkg_offset += _arg_size; } while (0); _total_len = _pkg_len; if (str_idxs) { _total_len += _s_cnt; if (_pbuf) { for (int i = 0; i < _s_cnt; i++) { _pbuf[_pkg_len + i] = _s_buffer[i]; } } } _plen = (_total_len > (int)_pmax) ? -
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3
 28 
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
...
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 ((void *)0)
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 ); } while (0); _mode = Z_LOG_MSG2_MODE_SYNC; } } while (0); } else { do { uint16_t src_id = 0 ? (__log_level ? log_dynamic_source_id(__log_current_dynamic_data) : 0) : (__log_level ? log_const_source_id(__log_current_const_data) : 0); struct log_msg_ids src_level = { .level = 3U, .domain_id = 0, .source_id = src_id }; do { if (is_user_context) { log_from_user(src_level, "%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)", thread, log_strdup(tname), unused, size - unused, size, pcnt); } else if (1) { log_string_sync(src_level, "%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)", thread, log_strdup(tname), unused, size - unused, size, pcnt); } else { do { log_arg_t args[] = {(log_arg_t)(thread) , (log_arg_t)(log_strdup(tname)) , (log_arg_t)(unused) , (log_arg_t)(size - unused) , (log_arg_t)(size) , (log_arg_t)(pcnt)}; log_n("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)", args, ((long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(args), __typeof__(&(args)[0])))]) - 1) + (sizeof(args) / sizeof((args)[0])))), src_level); } while (
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 0
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 ); } } while (
...
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 0
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 ) { z_log_printf_arg_checker("%p (%s):\tunused %zu\tusage %zu / %zu (%u %%)", thread, log_strdup(tname), unused, size - unused, size, pcnt); } } while (
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h" 3 4
 0
# 34 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/stack.h"
 )
...
# 19 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
...
# 20 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
...
# 24 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2

# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h" 1
# 36 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h"
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/devicetree_reserved.h" 1
# 37 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h" 2
# 194 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h"
...
# 217 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h"
...
# 239 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h"
...
# 276 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h"
extern char _end[];
# 345 "/home/sebin/thesis/zephyrproject/zephyr/include/linker/linker-defs.h"
extern char __ramfunc_start[];
extern char __ramfunc_end[];
extern char __ramfunc_size[];
extern char __ramfunc_load_start[];
# 26 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
...
# 27 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2



# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h" 1
# 36 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
...
# 64 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
...
# 93 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
       ...
       uint32_t flags)
{
 ...
 if (__builtin_expect((
# 101 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h" 3 4
    _Bool
# 101 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
    )!!(!api->get_entropy_isr), 
# 101 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h" 3 4
    0
# 101 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
  ...
  return -
# 102 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h" 3
         134
# 102 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
                ;
 }

 return api->get_entropy_isr(dev, buffer, length, flags);
}
# 117 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h"
# 1 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/entropy.h" 1
# 18 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/entropy.h"
#pragma GCC diagnostic push
...
static inline int entropy_get_entropy(const struct device * dev, uint8_t * buffer, uint16_t length)
{
 ...
 do { __asm__ __volatile__ ("" ::: "memory"); } while (
# 43 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/entropy.h" 3 4
0
# 43 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/entropy.h"
);
 return z_impl_entropy_get_entropy(dev, buffer, length);
}
# 60 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/entropy.h"
#pragma GCC diagnostic pop
# 118 "/home/sebin/thesis/zephyrproject/zephyr/include/drivers/entropy.h" 2
# 31 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 1
# 10 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 1
# 27 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
struct log_backend;
...
# 59 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 3 4
_Bool 
# 59 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
     active;
};
...
# 69 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 3 4
_Bool 
# 69 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
     autostart;
};

extern const struct log_backend __log_backends_start[];
extern const struct log_backend __log_backends_end[];
# 109 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 126 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 147 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 173 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 195 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 200 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 3 4
                             ((void *)0)
# 200 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
                                 ) {
...
# 224 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 239 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
static inline uint8_t log_backend_id_get(const struct log_backend *const backend)
{
 { };
 return backend->cb->id;
}
# 252 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
     ...
     void *ctx)
{
 ...
 backend->cb->ctx = ctx;
 backend->cb->active = 
# 278 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 3 4
                      1
# 278 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
                          ;
}
    ...
    const struct log_backend *const backend)
{
 { };
 backend->cb->active = 
# 290 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 3 4
                      0
# 290 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
                           ;
}
# 300 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
static inline 
# 300 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h" 3 4
             _Bool 
# 300 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_backend.h"
...
# 11 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 2

# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h" 1
# 28 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h"
void z_log_dropped(
# 28 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h" 3 4
                  _Bool 
# 28 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h"
                       buffered);
...
# 41 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h" 3 4
_Bool 
# 41 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h"
...
# 100 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h" 3 4
_Bool 
# 100 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h"
    z_log_msg2_pending(void);
...
# 13 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 2
# 33 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
...
void log_init(void);
# 57 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
void log_thread_set(k_tid_t process_tid);
# 67 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
int log_set_timestamp_func(log_timestamp_get_t timestamp_getter,
      uint32_t freq);
# 80 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
static inline void log_panic(void);
# 90 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
static inline 
# 90 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 3 4
         _Bool 
# 90 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
              log_process(
# 90 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 3 4
...
# 115 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
...
# 135 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
uint32_t log_filter_get(struct log_backend const *const backend,
   uint32_t domain_id, int16_t source_id, 
# 136 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 3 4
                                         _Bool 
# 136 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
                                              runtime);
# 149 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
static inline uint32_t log_filter_set(struct log_backend const *const backend,
      uint32_t domain_id, int16_t source_id,
      uint32_t level);
# 161 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
...
# 202 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
static inline 
# 202 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 3 4
             _Bool 
# 202 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
                  log_data_pending(void)
{
 ...
 return 
# 209 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 3 4
       0
# 209 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
            ;
}
# 221 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
int log_set_tag(const char *tag);
# 235 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h"
# 1 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 1
# 18 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
#pragma GCC diagnostic push
...
static inline void log_panic(void)
{
 ...
 do { __asm__ __volatile__ ("" ::: "memory"); } while (
# 44 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
0
# 44 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
);
 z_impl_log_panic();
}
# 56 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
extern 
# 56 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
      _Bool 
# 56 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
           z_impl_log_process(
# 56 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
...
static inline 
# 59 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
             _Bool 
# 59 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
                  log_process(
# 59 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
                              _Bool 
# 59 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
                                   bypass)
{
 ...
 do { __asm__ __volatile__ ("" ::: "memory"); } while (
# 67 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
0
# 67 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
);
 return z_impl_log_process(bypass);
}
# 79 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
...
static inline uint32_t log_buffered_cnt(void)
{
 ...
 do { __asm__ __volatile__ ("" ::: "memory"); } while (
# 90 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
0
# 90 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
);
 return z_impl_log_buffered_cnt();
}
# 102 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
...
static inline uint32_t log_filter_set(struct log_backend const *const backend, uint32_t domain_id, int16_t source_id, uint32_t level)
{
 ...
 do { __asm__ __volatile__ ("" ::: "memory"); } while (
# 113 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h" 3 4
0
# 113 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
);
 return z_impl_log_filter_set(backend, domain_id, source_id, level);
}
# 130 "/home/sebin/thesis/dmz/zephyr_xmc_template/build/zephyr/include/generated/syscalls/log_ctrl.h"
#pragma GCC diagnostic pop
# 236 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_ctrl.h" 2
# 32 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2


# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/gcov.h" 1
# 14 "/home/sebin/thesis/zephyrproject/zephyr/include/debug/gcov.h"
static inline void gcov_coverage_dump(void) { }
static inline void gcov_static_init(void) { }
# 35 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h" 1
# 19 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h"
extern struct k_spinlock sched_spinlock;
# 28 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h"
void z_smp_release_global_lock(struct k_thread *thread);
# 178 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h"
...
# 214 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h"
...
# 231 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h" 3 4
                              ((void *)0)
# 231 "/home/sebin/thesis/zephyrproject/zephyr/kernel/include/kswap.h"
                                  ;


 (&_kernel.cpus[0])->current = dummy_thread;
}
# 36 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/timing/timing.h" 1
# 11 "/home/sebin/thesis/zephyrproject/zephyr/include/timing/timing.h"
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/timing/types.h" 1
# 10 "/home/sebin/thesis/zephyrproject/zephyr/include/timing/types.h"
typedef uint64_t timing_t;
# 12 "/home/sebin/thesis/zephyrproject/zephyr/include/timing/timing.h" 2
...
# 37 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 2

const struct log_source_const_data log_const_os __attribute__ ((section("." "log_const_os"))) __attribute__((used)) = { .name = "os", .level = 3 }; extern const struct log_source_const_data log_const_os; extern struct log_source_dynamic_data log_dynamic_os; static const struct log_source_const_data * __log_current_const_data __attribute__((__unused__)) = 3 ? &log_const_os : 
# 38 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
((void *)0)
# 38 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
; static struct log_source_dynamic_data * __log_current_dynamic_data __attribute__((__unused__)) = (3 && 0) ? &log_dynamic_os : 
# 38 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
((void *)0)
# 38 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 44 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
__attribute__((__aligned__(
# 44 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
((((32) > (128)) ? (32) : (128)))
# 44 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
))) 
# 44 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
z_main_stack[((((unsigned long)(4096) + ((unsigned long)(8) - 1)) & ~((unsigned long)(8) - 1)) + ((size_t)32))];
...
# 51 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
      __attribute__((__aligned__(
# 51 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
      ((((32) > (128)) ? (32) : (128)))
# 51 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
      ))) 
# 51 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
      z_idle_stacks[1][(((unsigned long)(((((unsigned long)(320) + ((unsigned long)(8) - 1)) & ~((unsigned long)(8) - 1)) + ((size_t)32))) + ((unsigned long)(((((32) > (128)) ? (32) : (128)))) - 1)) & ~((unsigned long)(((((32) > (128)) ? (32) : (128)))) - 1))]

                              ;
# 64 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
struct z_thread_stack_element __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/zephyr/kernel/init.c\"" "." "2"))) 
# 64 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
__attribute__((__aligned__(
# 64 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
((((32) > (128)) ? (32) : (128)))
# 64 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
...
# 64 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
z_interrupt_stacks[1][(((unsigned long)(((((unsigned long)(2048) + ((unsigned long)(8) - 1)) & ~((unsigned long)(8) - 1)) + ((size_t)32))) + ((unsigned long)(((((32) > (128)) ? (32) : (128)))) - 1)) & ~((unsigned long)(((((32) > (128)) ? (32) : (128)))) - 1))]

                             ;

extern void idle(void *unused1, void *unused2, void *unused3);
# 83 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"

void z_bss_zero(void)
{
 (void)
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3
      ((__builtin_object_size(
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
      __bss_start
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3
      , 0) != (size_t)-1) ? __builtin___memset_chk(
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 86 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
                                                     ;
# 104 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
}
# 152 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"


# 153 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
_Bool 
# 153 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
    z_sys_post_kernel;
...
static void bg_thread_main(void *unused1, void *unused2, void *unused3)
{
 ...
 (void)(unused2);
 (void)(unused3);
# 178 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
 z_sys_post_kernel = 
# 178 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
                    1
# 178 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
                        ;
...
# 209 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 239 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
    ((void *)0)
# 239 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
        , 
# 239 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
          ((void *)0)
# 239 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 265 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
static char *prepare_multithreading(void)
{
 ...
 z_sched_init();
# 283 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
 _kernel.ready_q.cache = &z_main_thread;

 stack_ptr = z_setup_new_thread(&z_main_thread, z_main_stack,
           4096, bg_thread_main,
           
# 287 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
          ((void *)0)
# 287 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
              , 
# 287 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c" 3 4
                ((void *)0)
# 287 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
 ...
 for (int i = 0; i < 1; i++) {
  ...
  _kernel.cpus[i].irq_stack =
   (Z_KERNEL_STACK_BUFFER(z_interrupt_stacks[i]) +
    (sizeof(z_interrupt_stacks[i]) - ((size_t)32)));
...
# 323 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 365 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
 while (length > 0U) {
  uint32_t rndbits;
...
# 397 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
...
# 437 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
 switch_to_main_thread(prepare_multithreading());
# 464 "/home/sebin/thesis/zephyrproject/zephyr/kernel/init.c"
 __builtin_unreachable();
}

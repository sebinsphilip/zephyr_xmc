# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
...
# 9 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h"
...
# 10 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h" 2
...
# 11 "/home/sebin/thesis/zephyrproject/zephyr/include/logging/log_internal.h" 2
...
# 7 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 2
...
# 8 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/syscall_handler.h" 1
# 9 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 2
# 20 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
...
void z_log_runtime_filters_init(void)
{
# 36 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
...
# 40 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
 0
# 40 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
 )
...
{
 return src_id < z_log_sources_count() ? log_name_get(src_id) : 
# 63 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
                                                               ((void *)0)
# 63 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
                                                                   ;
}
          ...
          uint32_t level)
{
 ...
 if (0) {
  ...
  if (backend == 
# 94 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
                ((void *)0)
# 94 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
                    ) {
   ...
   uint32_t max = log_filter_get(backend, domain_id,
            source_id, 
# 110 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
                      0
# 110 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
                           );

   level = (((level) < (max)) ? (level) : (max));

   do { *(filters) &= ~(((1UL << (3U)) - 1U) << (3U * (log_backend_id_get(backend)))); *(filters) |= ((level) & ((1UL << (3U)) - 1U)) << (3U * (log_backend_id_get(backend))); } while (
# 114 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
  0
# 114 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
  )
   ...
   do { *(filters) &= ~(((1UL << (3U)) - 1U) << (3U * (0))); *(filters) |= ((new_aggr_filter) & ((1UL << (3U)) - 1U)) << (3U * (0)); } while (
# 123 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
  0
# 123 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
  )
...
# 153 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
static void backend_filter_set(struct log_backend const *const backend,
          uint32_t level)
{
 if (0) {
  for (int i = 0; i < z_log_sources_count(); i++) {
   log_filter_set(backend, 0, i, level);
  }
 }
}
...
uint32_t log_filter_get(struct log_backend const *const backend,
   uint32_t domain_id, int16_t source_id, 
# 190 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c" 3 4
                                         _Bool 
# 190 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_mgmt.c"
                                              runtime)
{
 { };
 ...
 if (0 && runtime) {
  ...
  return ((*(filters) >> (3U * (log_backend_id_get(backend)))) & ((1UL << (3U)) - 1U))
                                    ;
 }

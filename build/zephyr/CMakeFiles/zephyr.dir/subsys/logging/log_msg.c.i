# 1 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
...
# 7 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 2
...
# 8 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 2
...
# 10 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 2




_Static_assert((sizeof(struct log_msg_ids) == sizeof(uint16_t)), "" "Structure must fit in 2 bytes")
                                      ;

_Static_assert((sizeof(struct log_msg_generic_hdr) == sizeof(uint16_t)), "" "Structure must fit in 2 bytes")
                                      ;

_Static_assert((sizeof(struct log_msg_std_hdr) == sizeof(uint16_t)), "" "Structure must fit in 2 bytes")
                                      ;

_Static_assert((sizeof(struct log_msg_hexdump_hdr) == sizeof(uint16_t)), "" "Structure must fit in 2 bytes")
                                      ;

_Static_assert((sizeof(union log_msg_head_data) == sizeof(struct log_msg_ext_head_data)), "" "Structure must be same size")

                                    ;
# 43 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
struct k_mem_slab log_msg_pool;
static uint8_t __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/zephyr/subsys/logging/log_msg.c\"" "." "0"))) 
# 44 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                       __attribute__((__aligned__(
# 44 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                       sizeof(void *)
# 44 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                       )))
  
# 45 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
 log_msg_pool_buf[0];

void log_msg_pool_init(void)
{
 k_mem_slab_init(&log_msg_pool, log_msg_pool_buf, sizeof(union log_msg_chunk), (0 / sizeof(union log_msg_chunk)));
}


static 
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
      _Bool 
# 53 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
           is_irq_unlocked(void)
{
 unsigned int key = arch_irq_lock();
 
# 56 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
_Bool 
# 56 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
     ret = arch_irq_unlocked(key);
...
static 
# 65 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
      _Bool 
# 65 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
           block_on_alloc(void)
{
 if (!0) {
  return 
# 68 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
        0
# 68 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
             ;
 }
...
union log_msg_chunk *log_msg_chunk_alloc(void)
{
 union log_msg_chunk *msg = 
# 76 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                           ((void *)0)
# 76 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                               ;
...
static void cont_free(struct log_msg_cont *cont)
{
 ...
 while (cont != 
# 98 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
               ((void *)0)
# 98 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                   ) {
  next = cont->next;
...
{
 union log_msg_chunk *msg = 
# 168 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                           ((void *)0)
# 168 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                               ;
 
# 169 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
_Bool 
# 169 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
     more;
 int err;
 ...
 if (0) {
  do {
   more = log_process(
# 174 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                     1
# 174 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                         );
   z_log_dropped(
# 175 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                1
# 175 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                    );
  ...
  z_log_dropped(
# 181 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
               0
# 181 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                    );
 }
 return msg;
...
static log_arg_t cont_arg_get(struct log_msg *msg, uint32_t arg_idx)
{
 ...
 if (arg_idx < (3U - (sizeof(void *)/sizeof(log_arg_t)))) {
  return msg->payload.ext.data.args[arg_idx];
 }


 cont = msg->payload.ext.next;
 arg_idx -= (3U - (sizeof(void *)/sizeof(log_arg_t)));

 while (arg_idx >= ((sizeof(struct log_msg) - sizeof(void *)) / sizeof(log_arg_t))) {
  arg_idx -= ((sizeof(struct log_msg) - sizeof(void *)) / sizeof(log_arg_t));
  cont = cont->next;
 }
...
log_arg_t log_msg_arg_get(struct log_msg *msg, uint32_t arg_idx)
{
 ...
 if (msg->hdr.params.std.nargs <= 3U) {
...
# 253 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
static struct log_msg *msg_alloc(uint32_t nargs)
{
 ...
 if ((msg == 
# 260 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
            ((void *)0)
# 260 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                ) || nargs <= 3U) {
  return msg;
 }
 ...
 n -= (3U - (sizeof(void *)/sizeof(log_arg_t)));
 next = &msg->payload.ext.next;
 *next = 
# 268 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
        ((void *)0)
# 268 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
            ;
 ...
 while (n > 0) {
  ...
  if (cont == 
# 273 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
             ((void *)0)
# 273 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                 ) {
   msg_free(msg);
   return 
# 275 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
         ((void *)0)
# 275 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
             ;
  }

  *next = cont;
  cont->next = 
# 279 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
              ((void *)0)
# 279 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                  ;
  next = &cont->next;
  n -= ((sizeof(struct log_msg) - sizeof(void *)) / sizeof(log_arg_t));
 }
...
static void copy_args_to_msg(struct log_msg *msg, log_arg_t *args, uint32_t nargs)
{
 ...
 if (nargs > 3U) {
  (void)
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       ((__builtin_object_size(
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.ext.data.args
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
...
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       (3U - (sizeof(void *)/sizeof(log_arg_t))) * sizeof(log_arg_t)
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , __builtin_object_size(
# 292 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.ext.data.args
...
# 293 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                                     ;
  nargs -= (3U - (sizeof(void *)/sizeof(log_arg_t)));
  args += (3U - (sizeof(void *)/sizeof(log_arg_t)));
 } else {
  (void)
# 297 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       ((__builtin_object_size(
# 297 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.single.args
# 297 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 297 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.single.args
...
# 298 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                 ;
  nargs = 0U;
 }

 while (nargs != 0U) {
  uint32_t cpy_args = (((nargs) < (((sizeof(struct log_msg) - sizeof(void *)) / sizeof(log_arg_t)))) ? (nargs) : (((sizeof(struct log_msg) - sizeof(void *)) / sizeof(log_arg_t))));

  (void)
# 305 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       ((__builtin_object_size(
# 305 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       cont->payload.args
# 305 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 305 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
...
# 306 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                    ;
  nargs -= cpy_args;
  args += cpy_args;
  cont = cont->next;
...
struct log_msg *log_msg_create_n(const char *str, log_arg_t *args, uint32_t nargs)
{
 ...
 struct log_msg *msg = 
# 317 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                       ((void *)0)
# 317 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                           ;

 msg = msg_alloc(nargs);

 if (msg != 
# 321 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
           ((void *)0)
# 321 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
               ) {
  msg->str = str;
           ...
           uint32_t length)
{
 ...
 length = (length > ((1UL << (14)) - 1)) ?
   ((1UL << (14)) - 1) : length;

 msg = (struct log_msg *)log_msg_chunk_alloc();
 if (msg == 
# 344 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
           ((void *)0)
# 344 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
               ) {
  return 
# 345 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
        ((void *)0)
# 345 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
            ;
 }


 msg->hdr.ref_cnt = 1;
 msg->hdr.params.hexdump.type = 1;
 msg->hdr.params.hexdump.length = length;
 msg->str = str;


 if (length > (3U * sizeof(log_arg_t))) {
  (void)
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       ((__builtin_object_size(
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.ext.data.bytes
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.ext.data.bytes
...
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       ((3U * sizeof(log_arg_t)) - sizeof(void *))
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , __builtin_object_size(
# 356 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.ext.data.bytes
...
# 358 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                         ;
  msg->payload.ext.next = 
# 359 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                         ((void *)0)
# 359 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                             ;
  msg->hdr.params.generic.ext = 1;

  data += ((3U * sizeof(log_arg_t)) - sizeof(void *));
  length -= ((3U * sizeof(log_arg_t)) - sizeof(void *));
 } else {
  (void)
# 365 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       ((__builtin_object_size(
# 365 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.single.bytes
# 365 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 365 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       msg->payload.single.bytes
...
# 365 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
 ...
 while (length > 0) {
  cont = (struct log_msg_cont *)log_msg_chunk_alloc();
  if (cont == 
# 374 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
             ((void *)0)
# 374 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                 ) {
   msg_free(msg);
   return 
# 376 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
         ((void *)0)
# 376 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
             ;
  }

  *prev_cont = cont;
  cont->next = 
# 380 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
              ((void *)0)
# 380 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                  ;
  prev_cont = &cont->next;

  chunk_length = (length > (sizeof(struct log_msg) - sizeof(void *))) ?
          (sizeof(struct log_msg) - sizeof(void *)) : length;

  (void)
# 386 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       ((__builtin_object_size(
# 386 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
       cont->payload.bytes
# 386 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
       , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 386 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
...
# 398 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
       _Bool 
# 398 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
            put_op)
{
 uint32_t available_len = msg->hdr.params.hexdump.length;
 struct log_msg_cont *cont = 
# 401 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                            ((void *)0)
# 401 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                ;
 uint8_t *head_data;
 uint32_t chunk_len;
 uint32_t req_len;
 ...
 if (available_len > (3U * sizeof(log_arg_t))) {
  chunk_len = ((3U * sizeof(log_arg_t)) - sizeof(void *));
 ...
 if (offset < chunk_len) {
  ...
  if (put_op) {
   (void)
# 432 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        ((__builtin_object_size(
# 432 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
        &head_data[offset]
# 432 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 432 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
...
# 432 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
   ...
   (void)
# 434 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        ((__builtin_object_size(
# 434 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
        data
# 434 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 434 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
...
# 434 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
  ...
  offset -= chunk_len;
  chunk_len = (sizeof(struct log_msg) - sizeof(void *));
  if (cont == 
# 442 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
             ((void *)0)
# 442 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                 ) {
   cont = msg->payload.ext.next;
  }
 ...
 while ((req_len > 0) && (cont != 
# 452 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                                 ((void *)0)
# 452 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                     )) {
  chunk_len = (sizeof(struct log_msg) - sizeof(void *)) - offset;
  cpy_len = req_len > chunk_len ? chunk_len : req_len;

  if (put_op) {
   (void)
# 457 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        ((__builtin_object_size(
# 457 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
        &cont->payload.bytes[offset]
# 457 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 457 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
        &cont->payload.bytes[offset]
...
# 458 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                      ;
  } else {
   (void)
# 460 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        ((__builtin_object_size(
# 460 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
        data
# 460 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3
        , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 460 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
...
# 461 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                ;
  }
...
void log_msg_hexdump_data_put(struct log_msg *msg,
         ...
         size_t offset)
{
 log_msg_hexdump_data_op(msg, data, length, offset, 
# 476 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                                                   1
# 476 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                                       );
}
...
{
 log_msg_hexdump_data_op(msg, data, length, offset, 
# 484 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c" 3 4
                                                   0
# 484 "/home/sebin/thesis/zephyrproject/zephyr/subsys/logging/log_msg.c"
                                                        );
}

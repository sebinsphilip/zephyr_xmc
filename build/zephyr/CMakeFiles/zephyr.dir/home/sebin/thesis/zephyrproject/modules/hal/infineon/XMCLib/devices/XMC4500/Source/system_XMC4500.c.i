# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
# 63 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
...
# 64 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c" 2
...
# 34 "/home/sebin/thesis/zephyrproject/modules/hal/cmsis/CMSIS/Core/Include/core_cm4.h"
...
# 35 "/home/sebin/thesis/zephyrproject/modules/hal/cmsis/CMSIS/Core/Include/core_cm4.h" 2
...
# 74 "/home/sebin/thesis/zephyrproject/modules/hal/cmsis/CMSIS/Core/Include/cmsis_gcc.h"
...
# 66 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Include/system_XMC4500.h" 1
# 67 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c" 2
# 336 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
...
# 364 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c" 3
 ((__builtin_object_size(
# 364 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
 g_chipid
# 364 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c" 3
...
__attribute__((weak)) void SystemCoreSetup(void)
{
  uint32_t temp;
  ...
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->CCR &= ~((1UL << 3U));

  temp = ((FLASH0_GLOBAL_TypeDef *) 0x58001000UL)->FCON;
  temp &= ~(0xfUL);
  temp |= (0x3U);
  ((FLASH0_GLOBAL_TypeDef *) 0x58001000UL)->FCON = temp;
}

__attribute__((weak)) void SystemCoreClockSetup(void)
{
# 411 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
  if((((SCU_POWER_TypeDef *) 0x50004200UL)->PWRSTAT & (0x1UL)) == 0)
  {
    ((SCU_POWER_TypeDef *) 0x50004200UL)->PWRSET |= (0x1UL);

    while((((SCU_POWER_TypeDef *) 0x50004200UL)->PWRSTAT & (0x1UL)) == 0)
    {
  ...
  {
    ((SCU_RESET_TypeDef *) 0x50004400UL)->RSTCLR |= (0x200UL);
    delay((7500UL));
  }
# 472 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 |= (0x80000UL);
  ...
  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 &= ~((0x2UL) | (0x10000UL));



  if ((((SCU_OSC_TypeDef *) 0x50004700UL)->OSCHPCTRL & (0x30UL)) != 0U)
  {
    ((SCU_OSC_TypeDef *) 0x50004700UL)->OSCHPCTRL &= ~((0x30UL) | (0xf0000UL));
    ((SCU_OSC_TypeDef *) 0x50004700UL)->OSCHPCTRL |= ((OSCHP_GetFrequency() / (2500000U)) - 1UL) << (16UL);


    ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON2 = 0;


    ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 &= ~(0x20000UL);

    while ((((SCU_PLL_TypeDef *) 0x50004710UL)->PLLSTAT & ((0x100UL) | (0x80UL) | (0x200UL))) != ((0x100UL) | (0x80UL) | (0x200UL)))
    {
  ...
  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 |= (0x1UL);
  ...
  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 |= (0x10UL);


  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 = (((79U) << (8UL)) |
                      ((((((12000000U) / ((1U) + 1UL)) * ((79U) + 1UL)) / (24000000UL)) - 1UL) << (16UL)) |
                      ((1U) << (24UL)));


  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 |= (0x40UL);


  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 &= ~(0x10UL);


  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON0 |= (0x40000UL);
  ...
  ((SCU_CLK_TypeDef *) 0x50004600UL)->SYSCLKCR |= (0x10000UL);
  ...
  ((SCU_CLK_TypeDef *) 0x50004600UL)->PBCLKCR = (0U);
  ((SCU_CLK_TypeDef *) 0x50004600UL)->CPUCLKCR = (0U);
  ((SCU_CLK_TypeDef *) 0x50004600UL)->CCUCLKCR = (0U);
  ((SCU_CLK_TypeDef *) 0x50004600UL)->WDTCLKCR = (0U | (0U << (16UL)));
  ((SCU_CLK_TypeDef *) 0x50004600UL)->EBUCLKCR = (0U);
  ((SCU_CLK_TypeDef *) 0x50004600UL)->USBCLKCR = (0U | (0U << (16UL)) | (3U));
  ...
  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 = (((79U) << (8UL)) |
                     ((((((12000000U) / ((1U) + 1UL)) * ((79U) + 1UL)) / 60000000U) - 1UL) << (16UL)) |
                     ((1U) << (24UL)));
  ...
  ((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 = (((79U) << (8UL)) |
                     ((((((12000000U) / ((1U) + 1UL)) * ((79U) + 1UL)) / 90000000U) - 1UL) << (16UL)) |
                     ((1U) << (24UL)));
...
# 670 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
  ((SCU_CLK_TypeDef *) 0x50004600UL)->CLKSET = (0U);
# 689 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/devices/XMC4500/Source/system_XMC4500.c"
...
__attribute__((weak)) void SystemCoreClockUpdate(void)
{
  ...
  if (((SCU_CLK_TypeDef *) 0x50004600UL)->SYSCLKCR & (0x10000UL))
  {

    if(((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON2 & (0x1UL))
    {
    ...
    if (((SCU_PLL_TypeDef *) 0x50004710UL)->PLLSTAT & (0x4UL))
    {


      pdiv = ((((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 & (0xf000000UL)) >> (24UL)) + 1;
      ndiv = ((((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 & (0x7f00UL)) >> (8UL)) + 1;
      kdiv = ((((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 & (0x7f0000UL)) >> (16UL)) + 1;
    ...
    else
    {
      ...
      kdiv = ((((SCU_PLL_TypeDef *) 0x50004710UL)->PLLCON1 & (0x7fUL)) >> (0UL)) + 1;
  ...
  temp = temp / ((((SCU_CLK_TypeDef *) 0x50004600UL)->SYSCLKCR & (0xffUL)) + 1);
  temp = temp / ((((SCU_CLK_TypeDef *) 0x50004600UL)->CPUCLKCR & (0x1UL)) + 1);

  SystemCoreClock = temp;
}

__attribute__((weak)) uint32_t OSCHP_GetFrequency(void)
{
  return (12000000U);
}

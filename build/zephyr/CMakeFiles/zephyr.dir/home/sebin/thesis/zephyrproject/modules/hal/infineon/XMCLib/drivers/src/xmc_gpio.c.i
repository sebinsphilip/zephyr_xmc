# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_gpio.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_gpio.c"
# 61 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_gpio.c"
...
# 62 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_gpio.c" 2
# 72 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_gpio.c"
void XMC_GPIO_SetMode(XMC_GPIO_PORT_t *const port, const uint8_t pin, const XMC_GPIO_MODE_t mode)
{
  ;
  ;

  port->IOCR[(uint32_t)pin >> 2U] &= ~(uint32_t)((uint32_t)(0xf8UL) << ((uint32_t)(8U) * ((uint32_t)pin & 0x3U)));
  port->IOCR[(uint32_t)pin >> 2U] |= (uint32_t)mode << ((uint32_t)(8U) * ((uint32_t)pin & 0x3U));
}

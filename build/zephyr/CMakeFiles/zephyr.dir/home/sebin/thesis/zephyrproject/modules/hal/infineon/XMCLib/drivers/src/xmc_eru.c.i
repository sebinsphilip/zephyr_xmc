# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
# 60 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eru.h" 1
# 67 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eru.h"
...
# 68 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eru.h" 2
...
# 61 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c" 2
# 132 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
                      ...
                      const XMC_ERU_ETL_CONFIG_t *const config)
{
  ...
  eru->EXISEL = (eru->EXISEL &
                 ~((uint32_t)((0x3UL) | (0xcUL)) << (channel * (4UL)))) |
                (config->input << (channel * (uint32_t)(4UL)));
                          ...
                          const XMC_ERU_ETL_INPUT_B_t input_b)
{
  ...
  eru->EXISEL = (eru->EXISEL & ~((uint32_t)((0x3UL) | (0xcUL)) << (channel * (4UL)))) |
                (((uint32_t)input_a | (uint32_t)(input_b << (2UL))) << (channel * (4UL)));
}
                                     ...
                                     const XMC_ERU_ETL_OUTPUT_TRIGGER_CHANNEL_t trigger)
{
  ...
  eru->EXICON_b[channel].PE = (uint8_t)
# 232 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c" 3 4
                                      1
# 232 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
                                          ;
}
...
void XMC_ERU_ETL_DisableOutputTrigger(XMC_ERU_t *const eru, const uint8_t channel)
{
  ...
  eru->EXICON_b[channel].PE = 
# 241 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c" 3 4
                             0
# 241 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
                                  ;
}
                                        ...
                                        const XMC_ERU_OGU_PATTERN_DETECTION_INPUT_t input)
{
  ...
  eru->EXOCON_b[channel].GEEN = 
# 254 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c" 3 4
                               1
# 254 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
                                   ;
}
...
void XMC_ERU_OGU_DisablePatternDetection(XMC_ERU_t *const eru, const uint8_t channel)
{
  ...
  eru->EXOCON_b[channel].GEEN = 
# 263 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c" 3 4
                               0
# 263 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eru.c"
                                    ;
}

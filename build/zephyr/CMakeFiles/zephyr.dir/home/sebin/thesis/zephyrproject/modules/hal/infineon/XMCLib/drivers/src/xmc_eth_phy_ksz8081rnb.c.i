# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
# 66 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h" 1
# 76 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
...
# 77 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h" 2
# 85 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
typedef enum XMC_ETH_PHY_STATUS
{
  XMC_ETH_PHY_STATUS_OK = 0U,
  XMC_ETH_PHY_STATUS_BUSY = 1U,
  XMC_ETH_PHY_STATUS_ERROR = 2U,
  XMC_ETH_PHY_STATUS_ERROR_DEVICE_ID = 3U,
  XMC_ETH_PHY_STATUS_ERROR_TIMEOUT = 4U
} XMC_ETH_PHY_STATUS_t;
# 101 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
typedef struct XMC_ETH_PHY_CONFIG
{
  XMC_ETH_LINK_INTERFACE_t interface;
  XMC_ETH_LINK_SPEED_t speed;
  XMC_ETH_LINK_DUPLEX_t duplex;
  
# 106 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h" 3 4
 _Bool 
# 106 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
      enable_auto_negotiate;
  
# 107 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h" 3 4
 _Bool 
# 107 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
      enable_loop_back;
} XMC_ETH_PHY_CONFIG_t;
# 131 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
int32_t XMC_ETH_PHY_Init(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr, const XMC_ETH_PHY_CONFIG_t *const config);
# 142 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
int32_t XMC_ETH_PHY_PowerDown(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 153 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
int32_t XMC_ETH_PHY_ExitPowerDown(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 164 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
int32_t XMC_ETH_PHY_Reset(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 178 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
XMC_ETH_LINK_STATUS_t XMC_ETH_PHY_GetLinkStatus(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 192 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
XMC_ETH_LINK_SPEED_t XMC_ETH_PHY_GetLinkSpeed(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 206 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
XMC_ETH_LINK_DUPLEX_t XMC_ETH_PHY_GetLinkDuplex(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 216 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"

# 216 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h" 3 4
_Bool 
# 216 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_phy.h"
    XMC_ETH_PHY_IsAutonegotiationCompleted(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr);
# 67 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c" 2
# 122 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
static int32_t XMC_ETH_PHY_IsDeviceIdValid(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr)
{
  ...
  if ((XMC_ETH_MAC_ReadPhy(eth_mac, phy_addr, (0x02U), &phy_id1) == XMC_ETH_MAC_STATUS_OK) &&
      (XMC_ETH_MAC_ReadPhy(eth_mac, phy_addr, (0x03U), &phy_id2) == XMC_ETH_MAC_STATUS_OK))
  {
    if ((phy_id1 == (0x0022U)) && ((phy_id2 & (uint16_t)0xfff0) == (0x1560U)))
    {
...
int32_t XMC_ETH_PHY_Init(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr, const XMC_ETH_PHY_CONFIG_t *const config)
{
  ...
  if (status == (int32_t)XMC_ETH_PHY_STATUS_OK)
  {
    ...
    if (status == (int32_t)XMC_ETH_PHY_STATUS_OK)
    {
      ...
      if (config->enable_auto_negotiate == 
# 175 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c" 3 4
                                          1
# 175 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
                                              )
      {
        reg_bmcr |= (0x1000U);
      }

      if (config->enable_loop_back == 
# 180 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c" 3 4
                                     1
# 180 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
                                         )
      {
        reg_bmcr |= (0x4000U);
      }

      status = (int32_t)XMC_ETH_MAC_WritePhy(eth_mac, phy_addr, (0x00U), reg_bmcr);
    }
  }
...
int32_t XMC_ETH_PHY_Reset(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr)
{
  ...
  status = (int32_t)XMC_ETH_MAC_WritePhy(eth_mac, phy_addr, (0x00U), (0x8000U));
  if (status == (int32_t)XMC_ETH_PHY_STATUS_OK)
  {

    do
    {
      status = XMC_ETH_MAC_ReadPhy(eth_mac, phy_addr, (0x00U), &reg_bmcr);
    }
    while ((reg_bmcr & (0x8000U)) != 0);
  }
...
XMC_ETH_LINK_STATUS_t XMC_ETH_PHY_GetLinkStatus(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr)
{
  ...
  XMC_ETH_MAC_ReadPhy(eth_mac, phy_addr, (0x01U), &val);

  return (XMC_ETH_LINK_STATUS_t)((val & (0x0004U)) ? XMC_ETH_LINK_STATUS_UP : XMC_ETH_LINK_STATUS_DOWN);
}
...
XMC_ETH_LINK_SPEED_t XMC_ETH_PHY_GetLinkSpeed(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr)
{
  ...
  XMC_ETH_MAC_ReadPhy(eth_mac, phy_addr, (0x1eU), &val);

  return (XMC_ETH_LINK_SPEED_t)(((val & (0x0003U)) - 1U) ? XMC_ETH_LINK_SPEED_100M : XMC_ETH_LINK_SPEED_10M);
}
...
XMC_ETH_LINK_DUPLEX_t XMC_ETH_PHY_GetLinkDuplex(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr)
{
  ...
  return (XMC_ETH_LINK_DUPLEX_t)((val & (0x0004U)) ? XMC_ETH_LINK_DUPLEX_FULL : XMC_ETH_LINK_DUPLEX_HALF);
}


# 273 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c" 3 4
_Bool 
# 273 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_phy_ksz8081rnb.c"
    XMC_ETH_PHY_IsAutonegotiationCompleted(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr)
{
  uint16_t val;

  XMC_ETH_MAC_ReadPhy(eth_mac, phy_addr, (0x01U), &val);
  return ((val & (0x0020U)) == (0x0020U));
}

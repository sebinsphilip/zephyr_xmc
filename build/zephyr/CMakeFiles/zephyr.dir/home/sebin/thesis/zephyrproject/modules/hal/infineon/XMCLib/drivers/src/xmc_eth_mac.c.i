# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
# 121 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 1
# 126 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
...
# 127 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 2



# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac_map.h" 1
# 56 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac_map.h"
typedef enum XMC_ETH_MAC_PORT_CTRL_MODE
{
  XMC_ETH_MAC_PORT_CTRL_MODE_MII = 0x0U,
  XMC_ETH_MAC_PORT_CTRL_MODE_RMII = 0x1U
...
{
  XMC_ETH_MAC_PORT_CTRL_RXD0_P2_2 = 0U,
  XMC_ETH_MAC_PORT_CTRL_RXD0_P0_2 = 1U,
  XMC_ETH_MAC_PORT_CTRL_RXD0_P14_8 = 2U,
  XMC_ETH_MAC_PORT_CTRL_RXD0_P5_0 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_RXD1_P2_3 = 0U,
  XMC_ETH_MAC_PORT_CTRL_RXD1_P0_3 = 1U,
  XMC_ETH_MAC_PORT_CTRL_RXD1_P14_9 = 2U,
  XMC_ETH_MAC_PORT_CTRL_RXD1_P5_1 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_RXD2_P5_8 = 0U,
  XMC_ETH_MAC_PORT_CTRL_RXD2_P6_4 = 1U
...
{
  XMC_ETH_MAC_PORT_CTRL_RXD3_P5_9 = 0U,
  XMC_ETH_MAC_PORT_CTRL_RXD3_P6_3 = 1U
...
{
  XMC_ETH_MAC_PORT_CTRL_CLK_RMII_P2_1 = 0U,
  XMC_ETH_MAC_PORT_CTRL_CLK_RMII_P0_0 = 1U,
  XMC_ETH_MAC_PORT_CTRL_CLK_RMII_P15_8 = 2U,
  XMC_ETH_MAC_PORT_CTRL_CLK_RMII_P6_5 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_CRS_DV_P2_5 = 0U,
  XMC_ETH_MAC_PORT_CTRL_CRS_DV_P0_1 = 1U,
  XMC_ETH_MAC_PORT_CTRL_CRS_DV_P15_9 = 2U,
  XMC_ETH_MAC_PORT_CTRL_CRS_DV_P5_2 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_CRS_P5_11 = 0U,
  XMC_ETH_MAC_PORT_CTRL_CRS_P5_4 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_RXER_P2_4 = 0U,
  XMC_ETH_MAC_PORT_CTRL_RXER_P0_11 = 1U,
  XMC_ETH_MAC_PORT_CTRL_RXER_P5_3 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_COL_P2_15 = 0U,
  XMC_ETH_MAC_PORT_CTRL_COL_P5_5 = 3U
...
{
  XMC_ETH_MAC_PORT_CTRL_CLK_TX_P5_10 = 0U,
  XMC_ETH_MAC_PORT_CTRL_CLK_TX_P6_6 = 1U
...
{
  XMC_ETH_MAC_PORT_CTRL_MDIO_P0_9 = 0U,
  XMC_ETH_MAC_PORT_CTRL_MDIO_P2_0 = 1U,
  XMC_ETH_MAC_PORT_CTRL_MDIO_P1_11 = 2U
} XMC_ETH_MAC_PORT_CTRL_MDIO_t;
# 131 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 2
# 199 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
typedef enum XMC_ETH_MAC_STATUS
{
  XMC_ETH_MAC_STATUS_OK = 0U,
  XMC_ETH_MAC_STATUS_BUSY = 1U,
  XMC_ETH_MAC_STATUS_ERROR = 2U
...
{
  XMC_ETH_MAC_TX_FRAME_FRAGMENT = 0x1U,
  XMC_ETH_MAC_TX_FRAME_EVENT = 0x2U,
  XMC_ETH_MAC_TX_FRAME_TIMESTAMP = 0x4U
...
{
  XMC_ETH_MAC_EVENT_PMT = (0x8UL) << 16,
  XMC_ETH_MAC_EVENT_TIMESTAMP = (0x200UL) << 16,
  XMC_ETH_MAC_EVENT_EARLY_RECEIVE = (0x4000UL),
  XMC_ETH_MAC_EVENT_BUS_ERROR = (0x2000UL),
  XMC_ETH_MAC_EVENT_EARLY_TRANSMIT = (0x400UL),
  XMC_ETH_MAC_EVENT_RECEIVE_WATCHDOG_TIMEOUT = (0x200UL),
  XMC_ETH_MAC_EVENT_RECEIVE_PROCESS_STOPPED = (0x100UL),
  XMC_ETH_MAC_EVENT_RECEIVE_BUFFER_UNAVAILABLE = (0x80UL),
  XMC_ETH_MAC_EVENT_RECEIVE = (0x40UL),
  XMC_ETH_MAC_EVENT_TRANSMIT_UNDERFLOW = (0x20UL),
  XMC_ETH_MAC_EVENT_RECEIVE_OVERFLOW = (0x10UL),
  XMC_ETH_MAC_EVENT_TRANSMIT_JABBER_TIMEOUT = (0x8UL),
  XMC_ETH_MAC_EVENT_TRANSMIT_BUFFER_UNAVAILABLE = (0x4UL),
  XMC_ETH_MAC_EVENT_TRANSMIT_PROCESS_STOPPED = (0x2UL),
  XMC_ETH_MAC_EVENT_TRANSMIT = (0x1UL)
} XMC_ETH_MAC_EVENT_t;
...
{
  XMC_ETH_LINK_SPEED_10M = 0UL << (14UL),
  XMC_ETH_LINK_SPEED_100M = 1UL << (14UL)
...
{
  XMC_ETH_LINK_DUPLEX_HALF = 0UL << (11UL),
  XMC_ETH_LINK_DUPLEX_FULL = 1UL << (11UL)
...
{
  XMC_ETH_MAC_ADDR_FILTER_MASK_BYTE0 = 0x01000000UL,
  XMC_ETH_MAC_ADDR_FILTER_MASK_BYTE1 = 0x02000000UL,
  XMC_ETH_MAC_ADDR_FILTER_MASK_BYTE2 = 0x04000000UL,
  XMC_ETH_MAC_ADDR_FILTER_MASK_BYTE3 = 0x08000000UL,
  XMC_ETH_MAC_ADDR_FILTER_MASK_BYTE4 = 0x10000000UL,
  XMC_ETH_MAC_ADDR_FILTER_MASK_BYTE5 = 0x20000000UL,
  XMC_ETH_MAC_ADDR_FILTER_SA = 0x40000000UL
...
{
  XMC_ETH_MAC_PMT_EVENT_ON_WAKEUP_FRAME = (0x4UL),
  XMC_ETH_MAC_PMT_EVENT_ON_MAGIC_PACKET = (0x2UL),
  XMC_ETH_MAC_PMT_EVENT_ON_UNICAST_FRAME_FILTER = (0x200UL)
...
{
  XMC_ETH_MAC_TIMESTAMP_CONFIG_FINE_UPDATE = (0x2UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_TS_INTERRUPT = (0x10UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_ALL_FRAMES = (0x100UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_PTPV2 = (0x400UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_PTP_OVER_ETHERNET = (0x800UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_PTP_OVER_IPV6 = (0x1000UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_PTP_OVER_IPV4 = (0x2000UL),
  XMC_ETH_MAC_TIMESTAMP_CONFIG_ENABLE_MAC_ADDRESS_FILTER = (0x40000UL)
...
{
  XMC_ETH_MAC_TIMESTAMP_STATUS_SECONDS_OVERFLOW = (0x1UL),
  XMC_ETH_MAC_TIMESTAMP_STATUS_TARGET_TIME_REACHED = (0x2UL),
  XMC_ETH_MAC_TIMESTAMP_STATUS_TARGET_TIMER_ERROR = (0x8UL),
} XMC_ETH_MAC_TIMESTAMP_STATUS_t;
# 340 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
...
# 434 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_Init(XMC_ETH_MAC_t *const eth_mac);
# 449 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_InitEx(XMC_ETH_MAC_t *const eth_mac);
# 462 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_InitRxDescriptors(XMC_ETH_MAC_t *const eth_mac);
# 475 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_InitTxDescriptors(XMC_ETH_MAC_t *const eth_mac);
# 487 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_Enable(XMC_ETH_MAC_t *const eth_mac);
# 499 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_Disable(XMC_ETH_MAC_t *const eth_mac);
# 511 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_Reset(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->BUS_MODE |= (uint32_t)(0x1UL);
  while ((eth_mac->regs->BUS_MODE & (uint32_t)(0x1UL)) != 0U)
  {
  }
}
# 533 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_ReadPhy(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr, uint8_t reg_addr, uint16_t *data);
# 549 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_WritePhy(XMC_ETH_MAC_t *const eth_mac, uint8_t phy_addr, uint8_t reg_addr, uint16_t data);
# 570 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetPortControl(XMC_ETH_MAC_t *const eth_mac, const XMC_ETH_MAC_PORT_CTRL_t port_ctrl)
{
  (void)eth_mac;
  ((ETH0_CON_GLOBAL_TypeDef *) 0x50004040UL)->CON = (uint32_t)port_ctrl.raw;
}
# 587 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_SetManagmentClockDivider(XMC_ETH_MAC_t *const eth_mac);
# 601 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetAddress(XMC_ETH_MAC_t *const eth_mac, uint64_t addr)
{
  eth_mac->regs->MAC_ADDRESS0_HIGH = (uint32_t)(addr >> 32);
  eth_mac->regs->MAC_ADDRESS0_LOW = (uint32_t)addr;
}
# 619 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetAddressEx(XMC_ETH_MAC_t *const eth_mac, const uint8_t *const addr);
# 631 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline uint64_t XMC_ETH_MAC_GetAddress(XMC_ETH_MAC_t *const eth_mac)
{
...
# 648 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_GetAddressEx(XMC_ETH_MAC_t *const eth_mac, uint8_t *const addr);
# 664 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetAddressPerfectFilter(XMC_ETH_MAC_t *const eth_mac, uint8_t index, const uint64_t addr, uint32_t flags);
# 680 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetAddressPerfectFilterEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, uint8_t *const addr, uint32_t flags);
# 694 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetAddressHashFilter(XMC_ETH_MAC_t *const eth_mac, const uint64_t hash);
# 708 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableFrameFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x80000000UL);
}
# 725 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableFrameFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x80000000UL);
}
# 742 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableHashPerfectFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x400UL);
}
# 758 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnablePerfectFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x400UL);
}
# 777 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableSourceAddressFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x200UL);
}
# 795 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableSourceAddressFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x200UL);
}
# 813 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableSourceAddressInverseFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x100UL);
}
# 830 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableSourceAddressInverseFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x100UL);
}
# 848 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableDestinationAddressInverseFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x8UL);
}
# 864 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableDestinationAddressInverseFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x8UL);
}
# 880 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableMulticastHashFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x4UL);
}
# 896 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableMulticastHashFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x4UL);
}
# 912 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableUnicastHashFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x2UL);
}
# 928 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableUnicastHashFilter(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x2UL);
}
# 948 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_SendFrame(XMC_ETH_MAC_t *const eth_mac,
    const uint8_t *frame,
    uint32_t len,
    uint32_t flags);
# 966 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
uint32_t XMC_ETH_MAC_ReadFrame(XMC_ETH_MAC_t *const eth_mac, uint8_t *const frame, uint32_t len);
# 978 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
uint32_t XMC_ETH_MAC_GetRxFrameSize(XMC_ETH_MAC_t *const eth_mac);
# 990 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableReceptionBroadcastFrames(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x20UL);
}
# 1007 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableReceptionBroadcastFrames(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x20UL);
}
# 1024 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableReceptionMulticastFrames(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x10UL);
}
# 1040 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableReceptionMulticastFrames(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x10UL);
}
# 1057 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnablePromiscuousMode(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER |= (uint32_t)(0x1UL);
}
# 1072 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisablePromiscuousMode(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_FRAME_FILTER &= (uint32_t)~(0x1UL);
}
# 1089 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableRxWatchdog(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x800000UL);
}
# 1104 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableRxWatchdog(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x800000UL);
}
# 1121 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableTxJabber(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x400000UL);
}
# 1136 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableTxJabber(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x400000UL);
}
# 1152 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableFrameBurst(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x200000UL);
}
# 1167 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableFrameBurst(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x200000UL);
}
# 1184 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableJumboFrame(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x100000UL);
}
# 1199 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableJumboFrame(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x100000UL);
}
# 1215 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableRxOwn(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x2000UL);
}
# 1231 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableRxOwn(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x2000UL);
}
# 1246 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableLoopback(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x1000UL);
}
# 1261 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableLoopback(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x1000UL);
}
# 1278 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetLink(XMC_ETH_MAC_t *const eth_mac,
    XMC_ETH_LINK_SPEED_t speed,
    XMC_ETH_LINK_DUPLEX_t duplex)
{
  eth_mac->regs->MAC_CONFIGURATION = (eth_mac->regs->MAC_CONFIGURATION &
                                      (uint32_t)~((0x800UL) | (0x4000UL))) |
                                     (uint32_t)speed | (uint32_t)duplex;
}
# 1297 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_ReturnRxDescriptor(XMC_ETH_MAC_t *const eth_mac);
# 1309 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline 
# 1309 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
               _Bool 
# 1309 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
                    XMC_ETH_MAC_IsRxDescriptorOwnedByDma(XMC_ETH_MAC_t *const eth_mac)
{
  return ((eth_mac->rx_desc[eth_mac->rx_index].status & (0x80000000U)) != 0U);
}
# 1324 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_ReturnTxDescriptor(XMC_ETH_MAC_t *const eth_mac);
# 1336 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline 
# 1336 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
               _Bool 
# 1336 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
                    XMC_ETH_MAC_IsTxDescriptorOwnedByDma(XMC_ETH_MAC_t *const eth_mac)
{
  return ((eth_mac->tx_desc[eth_mac->tx_index].status & (0x80000000U)) != 0U);
}
# 1351 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline 
# 1351 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
               _Bool 
# 1351 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
                    XMC_ETH_MAC_IsTxDescriptorOwnedByDmaEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index)
{
  return ((eth_mac->tx_desc[index].status & (0x80000000U)) != 0U);
}
# 1368 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableRx(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->OPERATION_MODE |= (uint32_t)(0x2UL);
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x4UL);
}
# 1384 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableRx(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x4UL);
  eth_mac->regs->OPERATION_MODE &= (uint32_t)~(0x2UL);
}
# 1402 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnableTx(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->OPERATION_MODE |= (uint32_t)(0x2000UL);
  eth_mac->regs->MAC_CONFIGURATION |= (uint32_t)(0x8UL);
}
# 1418 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisableTx(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->MAC_CONFIGURATION &= (uint32_t)~(0x8UL);
  eth_mac->regs->OPERATION_MODE &= (uint32_t)~(0x2000UL);
}
# 1434 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_FlushTx(XMC_ETH_MAC_t *const eth_mac);
# 1446 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_FlushRx(XMC_ETH_MAC_t *const eth_mac);
# 1461 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_ResumeTx(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->STATUS = (uint32_t)(0x2UL);
  eth_mac->regs->TRANSMIT_POLL_DEMAND = 0U;
}
# 1480 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_ResumeRx(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->STATUS = (uint32_t)(0x80UL);
  eth_mac->regs->RECEIVE_POLL_DEMAND = 0U;
}
# 1493 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline uint8_t XMC_ETH_MAC_GetCurrentTxDescIndex(XMC_ETH_MAC_t *const eth_mac)
{
  return eth_mac->tx_index;
}
# 1505 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline uint8_t XMC_ETH_MAC_GetCurrentRxDescIndex(XMC_ETH_MAC_t *const eth_mac)
{
  return eth_mac->rx_index;
}
# 1517 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline uint8_t *XMC_ETH_MAC_GetTxBuffer(XMC_ETH_MAC_t *const eth_mac)
{
  return (uint8_t *)(eth_mac->tx_desc[eth_mac->tx_index].buffer1);
}
# 1529 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline uint8_t *XMC_ETH_MAC_GetTxBufferEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index)
{
  return (uint8_t *)(eth_mac->tx_desc[index].buffer1);
}
# 1542 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetTxBuffer(XMC_ETH_MAC_t *const eth_mac, const uint8_t *const address)
{
  eth_mac->tx_desc[eth_mac->tx_index].buffer1 = (uint32_t)address;
}
# 1555 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetTxBufferEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, const uint8_t *const address)
{
  eth_mac->tx_desc[index].buffer1 = (uint32_t)address;
}
# 1568 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetRxBuffer(XMC_ETH_MAC_t *const eth_mac, const uint8_t *const address)
{
  eth_mac->rx_desc[eth_mac->rx_index].buffer1 = (uint32_t)address;
}
# 1581 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetRxBufferEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, const uint8_t *const address)
{
  eth_mac->rx_desc[index].buffer1 = (uint32_t)address;
}
# 1593 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline uint8_t *XMC_ETH_MAC_GetRxBuffer(XMC_ETH_MAC_t *const eth_mac)
{
  return (uint8_t *)(eth_mac->rx_desc[eth_mac->rx_index].buffer1);
}
# 1606 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetTxBufferSize(XMC_ETH_MAC_t *const eth_mac, uint32_t size)
{
  eth_mac->tx_desc[eth_mac->tx_index].length = size;
}
# 1619 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_SetTxBufferSizeEx(XMC_ETH_MAC_t *const eth_mac, uint8_t index, uint32_t size)
{
  eth_mac->tx_desc[index].length = size;
}
# 1636 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnablePowerManagmentEvent(XMC_ETH_MAC_t *const eth_mac, uint32_t event)
{
  eth_mac->regs->PMT_CONTROL_STATUS |= (uint32_t)event;
}
# 1653 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisablePowerManagmentEvent(XMC_ETH_MAC_t *const eth_mac, uint32_t event)
{
  eth_mac->regs->PMT_CONTROL_STATUS &= ~(uint32_t)event;
}
# 1669 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetWakeUpFrameFilter(XMC_ETH_MAC_t *const eth_mac,
                                      const uint32_t (*const filter)[(8U)]);
# 1682 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline 
# 1682 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
               _Bool 
# 1682 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
                    XMC_ETH_MAC_IsMagicPacketReceived(XMC_ETH_MAC_t *const eth_mac)
{
  return (
# 1684 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
         _Bool
# 1684 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
             )(eth_mac->regs->PMT_CONTROL_STATUS & (uint32_t)(0x20UL));
}
# 1697 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline 
# 1697 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
               _Bool 
# 1697 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
                    XMC_ETH_MAC_IsWakeupFrameReceived(XMC_ETH_MAC_t *const eth_mac)
{
  return (
# 1699 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h" 3 4
         _Bool
# 1699 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
             )(eth_mac->regs->PMT_CONTROL_STATUS & (uint32_t)(0x40UL));
}
# 1712 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnablePowerDownMode(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->PMT_CONTROL_STATUS |= (uint32_t)(0x1UL);
}
# 1727 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisablePowerDownMode(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->PMT_CONTROL_STATUS &= ~(uint32_t)(0x1UL);
}
# 1743 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetVLANTag(XMC_ETH_MAC_t *const eth_mac, uint32_t tag);
# 1756 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_InitPTP(XMC_ETH_MAC_t *const eth_mac, uint32_t config);
# 1770 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_InitPTPEx(XMC_ETH_MAC_t *const eth_mac, uint32_t config, XMC_ETH_MAC_TIME_t *const time);
# 1784 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_GetPTPTime(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time);
# 1797 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetPTPTime(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time);
# 1811 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_UpdatePTPTime(XMC_ETH_MAC_t *const eth_mac, const XMC_ETH_MAC_TIME_t *const time);
# 1825 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_SetPTPAlarm(XMC_ETH_MAC_t *const eth_mac, const XMC_ETH_MAC_TIME_t *const time);
# 1838 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_EnablePTPAlarm(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->TIMESTAMP_CONTROL |= (uint32_t)(0x10UL);
}
# 1854 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
static inline void XMC_ETH_MAC_DisablePTPAlarm(XMC_ETH_MAC_t *const eth_mac)
{
  eth_mac->regs->TIMESTAMP_CONTROL &= (uint32_t)~(0x10UL);
}
# 1871 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_UpdateAddend(XMC_ETH_MAC_t *const eth_mac, uint32_t addend);
# 1885 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_AdjustPTPClock(XMC_ETH_MAC_t *const eth_mac, uint32_t correction);
# 1899 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
uint32_t XMC_ETH_MAC_GetPTPStatus(const XMC_ETH_MAC_t *const eth_mac);
# 1912 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_GetRxTimeStamp(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time);
# 1925 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_GetTxTimeStamp(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time);
# 1938 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_EnableEvent(XMC_ETH_MAC_t *const eth_mac, uint32_t event);
# 1951 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_DisableEvent(XMC_ETH_MAC_t *const eth_mac, uint32_t event);
# 1964 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
void XMC_ETH_MAC_ClearEventStatus(XMC_ETH_MAC_t *const eth_mac, uint32_t event);
# 1977 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_eth_mac.h"
uint32_t XMC_ETH_MAC_GetEventStatus(const XMC_ETH_MAC_t *const eth_mac);
# 122 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 2
...
# 126 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 2
...
# 127 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 2
# 201 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
static inline 
# 201 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
               _Bool 
# 201 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                    XCM_ETH_MAC_IsNormalEvent(uint32_t event)
{
  return (
# 203 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
         _Bool
# 203 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
             )((event & ((uint32_t)XMC_ETH_MAC_EVENT_TRANSMIT |
...
static inline 
# 210 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
               _Bool 
# 210 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                    XCM_ETH_MAC_IsAbnormalEvent(uint32_t event)
{
  return (
# 212 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
         _Bool
# 212 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
             )((event & ((uint32_t)XMC_ETH_MAC_EVENT_TRANSMIT_PROCESS_STOPPED |
...
# 233 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
void XMC_ETH_MAC_InitEx(XMC_ETH_MAC_t *const eth_mac)
{
  ;
  ...
  eth_mac->regs->MAC_CONFIGURATION = (uint32_t)(0x400UL);


  eth_mac->regs->FLOW_CONTROL = (0x80UL);

  eth_mac->regs->OPERATION_MODE = (uint32_t)(0x2000000UL) |
                                  (uint32_t)(0x200000UL) |
                                  (uint32_t)(0x4UL);


  eth_mac->regs->BUS_MODE = (uint32_t)(0x80UL) |
                            (uint32_t)(0x2000000UL) |
                            (uint32_t)(0x10000UL) |
                            (uint32_t)(0x20 << (8UL));
  ...
  eth_mac->regs->INTERRUPT_MASK = (0x8UL) | (0x200UL);

  eth_mac->frame_end = 
# 270 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
                      ((void *)0)
# 270 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                          ;
}
...
void XMC_ETH_MAC_InitRxDescriptors(XMC_ETH_MAC_t *const eth_mac)
{
  ...
  {
    eth_mac->rx_desc[i].status = (uint32_t)(0x80000000U);
    eth_mac->rx_desc[i].length = (uint32_t)(0x00004000U) | (uint32_t)(1524);

    if (eth_mac->rx_buf != 
# 307 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
                          ((void *)0)
# 307 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                              )
    {
      eth_mac->rx_desc[i].buffer1 = (uint32_t) & (eth_mac->rx_buf[i * (1524)]);
    }
    else
    {
...
void XMC_ETH_MAC_InitTxDescriptors(XMC_ETH_MAC_t *const eth_mac)
{
  ...
  {
    eth_mac->tx_desc[i].status = (0x00100000U) | (0x20000000U) | (0x10000000U) | (0x40000000U);

    if (eth_mac->tx_buf != 
# 340 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
                          ((void *)0)
# 340 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                              )
    {
      eth_mac->tx_desc[i].buffer1 = (uint32_t) & (eth_mac->tx_buf[i * (1524)]);
    }
    else
    {
...
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_SendFrame(XMC_ETH_MAC_t *const eth_mac, const uint8_t *frame, uint32_t len, uint32_t flags)
{
  ...
  if (eth_mac->tx_desc[eth_mac->tx_index].status & (0x80000000U))
  {

    status = XMC_ETH_MAC_STATUS_BUSY;
    if (eth_mac->regs->STATUS & (0x4UL))
    {

      eth_mac->regs->STATUS = (uint32_t)(0x4UL);
      eth_mac->regs->TRANSMIT_POLL_DEMAND = 0U;
    }
  ...
  {
    if (dst == 
# 444 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
              ((void *)0)
# 444 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                  )
    {
...
# 456 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3
   ((__builtin_object_size(
# 456 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
   dst
# 456 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3
...
# 456 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
    ...
    else
    {
      ...
      ctrl = eth_mac->tx_desc[eth_mac->tx_index].status | (0x00C00000U);
      ctrl &= ~((0x40000000U) | (0x02000000U));
      ...
      eth_mac->tx_desc[eth_mac->tx_index].status = ctrl | (0x80000000U);
      ...
      eth_mac->frame_end = 
# 487 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
                          ((void *)0)
# 487 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                              ;
...
# 511 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3
 ((__builtin_object_size(
# 511 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
 frame
# 511 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3
 , 0) != (size_t)-1) ? __builtin___memcpy_chk(
# 511 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
...
# 511 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
  ...
  eth_mac->rx_desc[eth_mac->rx_index].status = (0x80000000U);
...
uint32_t XMC_ETH_MAC_GetRxFrameSize(XMC_ETH_MAC_t *const eth_mac)
{
  ...
  else if (((status & (0x00008000U)) != 0U) ||
           ((status & (0x00000200U)) == 0U) ||
           ((status & (0x00000100U)) == 0U))
  {
...
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_SetManagmentClockDivider(XMC_ETH_MAC_t *const eth_mac)
{
  ...
  else if (eth_mac_clk <= (200000000U))
  {
    *reg = (4U << (2UL));
  }
...
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_ReadPhy(XMC_ETH_MAC_t *eth_mac, uint8_t phy_addr, uint8_t reg_addr, uint16_t *data)
{
  ...
  eth_mac->regs->GMII_ADDRESS = (uint32_t)((eth_mac->regs->GMII_ADDRESS & (uint32_t)(0x3cUL)) |
                                (uint32_t)(0x1UL) |
                                (uint32_t)((uint32_t)phy_addr << (11UL)) |
                                (uint32_t)((uint32_t)reg_addr << (6UL)));


  retries = 0U;
  do
  {
    if ((eth_mac->regs->GMII_ADDRESS & (0x1UL)) == 0U)
    {
      *data = (uint16_t)(eth_mac->regs->GMII_DATA & (0xffffUL));
      return XMC_ETH_MAC_STATUS_OK;
    }
    ++retries;
  }
  while (retries < (0xffffUL));
...
void XMC_ETH_MAC_EnableEvent(XMC_ETH_MAC_t *const eth_mac, uint32_t event)
{
  ...
  {
    event |= (uint32_t)(0x10000UL);
  }

  if (XCM_ETH_MAC_IsAbnormalEvent(event))
  {
    event |= (uint32_t)(0x8000UL);
  }
...
void XMC_ETH_MAC_ClearEventStatus(XMC_ETH_MAC_t *const eth_mac, uint32_t event)
{
  ...
  if ((eth_mac->regs->STATUS & (0x10000UL)) != 0U)
  {
    event |= (uint32_t)(0x10000UL);
  }

  if ((eth_mac->regs->STATUS & (0x8000UL)) != 0U)
  {
    event |= (uint32_t)(0x8000UL);
  }
...
uint32_t XMC_ETH_MAC_GetEventStatus(const XMC_ETH_MAC_t *const eth_mac)
{
  ...
  return ((uint32_t)((eth_mac->regs->INTERRUPT_STATUS & ((0x8UL) | (0x200UL))) << 16U) |
          temp_status);
}
...
void XMC_ETH_MAC_ReturnTxDescriptor(XMC_ETH_MAC_t *const eth_mac)
{
  ...
  eth_mac->tx_desc[eth_mac->tx_index].status |= (0x00C00000U) | (0x80000000U);
  eth_mac->tx_index++;
  if (eth_mac->tx_index == eth_mac->num_tx_buf)
  {
    eth_mac->tx_index = 0U;
  ...
  eth_mac->frame_end = 
# 798 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c" 3 4
                      ((void *)0)
# 798 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_eth_mac.c"
                          ;
}
...
void XMC_ETH_MAC_InitPTP(XMC_ETH_MAC_t *const eth_mac, uint32_t config)
{
  ...
  eth_mac->regs->INTERRUPT_MASK |= (uint32_t)(0x200UL);


  eth_mac->regs->TIMESTAMP_CONTROL = (0x1UL) | (0x200UL) | config;
  ...
  if ((config & (uint32_t)XMC_ETH_MAC_TIMESTAMP_CONFIG_FINE_UPDATE) != 0U)
  {
    ...
    float ratio = (float)XMC_SCU_CLOCK_GetSystemClockFrequency() / (float)(50000000);
    eth_mac->regs->TIMESTAMP_ADDEND = (uint32_t)(((float)0x100000000ULL / ratio) + 0.5F);


    eth_mac->regs->TIMESTAMP_CONTROL |= (uint32_t)(0x20UL);


    while (eth_mac->regs->TIMESTAMP_CONTROL & (0x20UL));
  }
  else
  {
  ...
  eth_mac->regs->TIMESTAMP_CONTROL |= (uint32_t)(0x4UL);
  while (eth_mac->regs->TIMESTAMP_CONTROL & (0x4UL));
}
...
void XMC_ETH_MAC_GetPTPTime(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time)
{
  ...
  time->nanoseconds = (uint32_t)(eth_mac->regs->SYSTEM_TIME_NANOSECONDS);
...
void XMC_ETH_MAC_SetPTPTime(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time)
{
  ...
  ((ETH_GLOBAL_TypeDef *) 0x5000C000UL)->TIMESTAMP_CONTROL |= (0x4UL);
  while (eth_mac->regs->TIMESTAMP_CONTROL & (0x4UL));
}
...
void XMC_ETH_MAC_UpdatePTPTime(XMC_ETH_MAC_t *const eth_mac, const XMC_ETH_MAC_TIME_t *const time)
{
  ...
  {
    temp |= (uint32_t)(0x80000000UL);
  }

  eth_mac->regs->SYSTEM_TIME_NANOSECONDS_UPDATE = temp;
  eth_mac->regs->SYSTEM_TIME_SECONDS_UPDATE = time->seconds;

  eth_mac->regs->TIMESTAMP_CONTROL |= (uint32_t)(0x8UL);
}
...
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_GetRxTimeStamp(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time)
{
  ...
  if (rx_desc->status & (0x80000000U))
  {
    status = XMC_ETH_MAC_STATUS_BUSY;
  }
  else
  {
    if ((rx_desc->status & ((0x00000080U) | (0x00000100U))) == ((0x00000080U) | (0x00000100U)))
    {
...
XMC_ETH_MAC_STATUS_t XMC_ETH_MAC_GetTxTimeStamp(XMC_ETH_MAC_t *const eth_mac, XMC_ETH_MAC_TIME_t *const time)
{
  ...
  if (tx_desc->status & (0x80000000U))
  {
    status = XMC_ETH_MAC_STATUS_BUSY;
  }
  else
  {
    if ((tx_desc->status & ((0x00020000U) | (0x20000000U))) == ((0x00020000U) | (0x20000000U)))
    {

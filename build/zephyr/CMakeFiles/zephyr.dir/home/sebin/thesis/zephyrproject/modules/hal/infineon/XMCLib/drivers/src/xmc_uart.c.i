# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
# 81 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
...
# 104 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc4_scu.h"
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_common.h" 1
# 105 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc4_scu.h" 2
...
# 82 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c" 2
...
# 83 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c" 2
# 95 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
void XMC_UART_CH_InitEx(XMC_USIC_CH_t *channel, const XMC_UART_CH_CONFIG_t *const config, 
# 95 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c" 3 4
                                                                                         _Bool 
# 95 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
                                                                                              init_brg)
{
...
# 130 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
  channel->PCR_ASCMode = (uint32_t)(((config->stop_bits - 1UL) << (1UL)) |
                                    (((oversampling >> 1UL) + 1UL) << (8UL)) |
                                    (0x1UL) |
                                    (0x10000UL) | (0x20000UL));
  ...
  channel->SCTR = (uint32_t)((((uint32_t)config->data_bits - 1UL) << (24UL)) |
                             ((0x1UL << (8UL)) | (0x2UL)));

  if (config->frame_length != 0U)
  {
    channel->SCTR |= (uint32_t)(((uint32_t)config->frame_length - 1UL) << (16UL));
  }
  else
  {
    channel->SCTR |= (uint32_t)(((uint32_t)config->data_bits - 1UL) << (16UL));
  }


  channel->TCSR = (0x1UL << (10UL)) |
                  (0x100UL);
...
XMC_UART_CH_STATUS_t XMC_UART_CH_SetBaudrate(XMC_USIC_CH_t *const channel, uint32_t rate, uint32_t oversampling)
{
  ...
  if ((rate <= (XMC_SCU_CLOCK_GetPeripheralClockFrequency() >> 2U)) && (oversampling >= (4UL)))
  {
...
XMC_UART_CH_STATUS_t XMC_UART_CH_SetBaudrateEx(XMC_USIC_CH_t *const channel, uint32_t rate, uint32_t oversampling, 
# 179 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c" 3 4
                                                                                                                  _Bool 
# 179 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_uart.c"
                                                                                                                       normal_divider_mode)
{
...
void XMC_UART_CH_Transmit(XMC_USIC_CH_t *const channel, const uint16_t data)
{
  ...
  if ((channel->TBCTR & (0x7000000UL)) == 0UL)
  {
...
uint16_t XMC_UART_CH_GetReceivedData(XMC_USIC_CH_t *const channel)
{
  ...
  if ((channel->RBCTR & (0x7000000UL)) == 0U)
  {

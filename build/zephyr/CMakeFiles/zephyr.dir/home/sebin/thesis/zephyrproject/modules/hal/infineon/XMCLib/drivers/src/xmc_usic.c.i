# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c"
...
# 1 "<command-line>" 2
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c"
# 93 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c"
# 1 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_usic.h" 1
# 121 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_usic.h"
...
# 122 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/inc/xmc_usic.h" 2
...
# 94 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c" 2
...
# 95 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c" 2
...
# 97 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c" 2
# 108 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c"
...
void XMC_USIC_CH_Enable(XMC_USIC_CH_t *const channel)
{
  ...
  if ((channel == ((XMC_USIC_CH_t *)0x40030000UL)) || (channel == ((XMC_USIC_CH_t *)0x40030200UL)))
  {
    XMC_USIC_Enable(((XMC_USIC_t *)0x40030008UL));
  }

  else if ((channel == ((XMC_USIC_CH_t *)0x48020000UL)) || (channel == ((XMC_USIC_CH_t *)0x48020200UL)))
  {
    XMC_USIC_Enable(((XMC_USIC_t *)0x48020008UL));
  }


  else if ((channel == ((XMC_USIC_CH_t *)0x48024000UL)) || (channel == ((XMC_USIC_CH_t *)0x48024200UL)))
  {
    XMC_USIC_Enable(((XMC_USIC_t *)0x48024008UL));
  }
  ...
  channel->KSCFG = ((0x1UL) | (0x2UL));
  while ((channel->KSCFG & (0x1UL)) == 0U)
  {

  }


  channel->CCR &= (uint32_t)~(0xfUL);
}

void XMC_USIC_CH_Disable(XMC_USIC_CH_t *const channel)
{
  channel->KSCFG = (uint32_t)((channel->KSCFG & (~(0x1UL))) | (0x2UL));
}
...
XMC_USIC_CH_STATUS_t XMC_USIC_CH_SetBaudrate(XMC_USIC_CH_t *const channel, uint32_t rate, uint32_t oversampling)
{
  ...
  if ((rate >= 100U) && (oversampling != 0U))
  {
    ...
    channel->FDR = XMC_USIC_CH_BRG_CLOCK_DIVIDER_MODE_FRACTIONAL |
                   ((clock_divider_min - 1) << (0UL));

    channel->BRG = (channel->BRG & ~((0x7c00UL) |
                                     (0x3ff0000UL) |
                                     (0x300UL) |
                                     (0x10UL))) |
                   ((oversampling - 1U) << (10UL)) |
                   ((pdiv_int_min - 1U) << (16UL));
...
XMC_USIC_CH_STATUS_t XMC_USIC_CH_SetBaudrateEx(XMC_USIC_CH_t *const channel, int32_t rate, int32_t oversampling)
{
  ...
  {
    divider_step = peripheral_clock / brg_clock;
...
# 262 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c" 3 4
                                   _Bool 
# 262 "/home/sebin/thesis/zephyrproject/modules/hal/infineon/XMCLib/drivers/src/xmc_usic.c"
                                        pppen,
                                    uint32_t pdiv,
                                    XMC_USIC_CH_BRG_CTQSEL_t ctqsel,
                                    uint32_t pctq,
                                    uint32_t dctq)
{
    ...
    regval &= (uint32_t)~((0x3UL) | (0x10UL) | (0x3ff0000UL) | (0xc0UL) | (0x300UL) | (0x7c00UL));
    regval |= clksel | (pppen ? (0x10UL) : 0) | (pdiv << (16UL)) | ctqsel | (pctq << (8UL)) | (dctq << (10UL));
    channel->BRG = regval;
}
...
uint32_t XMC_USIC_CH_GetBaudrate(XMC_USIC_CH_t *const channel)
{
  ...
  else
  {
    ...
    divider = (channel->BRG & (0x10UL)) ? 2 : 1;

    if ((((channel->BRG & (0xc0UL)) >> (6UL)) & 0x1) == 0)
    {

      divider *= ((channel->BRG & (0x3ff0000UL)) >> (16UL)) + 1;
      if ((((channel->BRG & (0xc0UL)) >> (6UL)) & 0x2) != 0)
      {
  ...
  divider *= ((channel->BRG & (0x300UL)) >> (8UL)) + 1;
  divider *= ((channel->BRG & (0x7c00UL)) >> (10UL)) + 1;

  uint32_t fperi = XMC_SCU_CLOCK_GetPeripheralClockFrequency();
  float baudrate;
  if ((channel->FDR & (0xc000UL)) == XMC_USIC_CH_BRG_CLOCK_DIVIDER_MODE_FRACTIONAL)
  {
    baudrate = fperi * (((channel->FDR & (0x3ffUL)) >> (0UL)) / 1024.0F);
  }
  else
  {

    baudrate = fperi * (1.0F / (1024 - ((channel->FDR & (0x3ffUL)) >> (0UL))));
  }
                                  ...
                                  const uint32_t limit)
{
  ...
  channel->TBCTR &= (uint32_t)~(0x7000000UL);
  ...
  channel->TBCTR = (uint32_t)(channel->TBCTR & (uint32_t)~((0x3f00UL) |
                              (0x3fUL) |
                              (0x7000000UL))) |
                   (uint32_t)((limit << (8UL)) |
                              (data_pointer << (0UL)) |
                                  ...
                                  const uint32_t limit)
{
  ...
  channel->RBCTR &= (uint32_t)~(0x7000000UL);




  channel->RBCTR = (uint32_t)((channel->RBCTR & (uint32_t)~((0x3f00UL) |
                               (0x3fUL) |
                               (0x10000000UL))) |
                              ((limit << (8UL)) |
                               (data_pointer << (0UL)) |
    ...
    const uint32_t limit)
{
  ...
  channel->TBCTR = (uint32_t)((uint32_t)(channel->TBCTR & (uint32_t)~(0x3f00UL)) |
                              (limit << (8UL)));
}
    ...
    const uint32_t limit)
{
  ...
  channel->RBCTR = (uint32_t)((uint32_t)(channel->RBCTR & (uint32_t)~(0x3f00UL)) |
                              (limit << (8UL)));
}
...
void XMC_USIC_CH_SetInterruptNodePointer(XMC_USIC_CH_t *const channel,
    ...
    const uint32_t service_request)
{
  channel->INPR = (uint32_t)((channel->INPR & (~(uint32_t)((0x7UL) << (uint32_t)interrupt_node))) |
...
void XMC_USIC_CH_TXFIFO_SetInterruptNodePointer(XMC_USIC_CH_t *const channel,
    ...
    const uint32_t service_request)
{
  channel->TBCTR = (uint32_t)((channel->TBCTR & (~(uint32_t)((0x7UL) << (uint32_t)interrupt_node))) |
                              (service_request << (uint32_t)interrupt_node));
}
...
void XMC_USIC_CH_RXFIFO_SetInterruptNodePointer(XMC_USIC_CH_t *const channel,
    ...
    const uint32_t service_request)
{
  channel->RBCTR = (uint32_t)((channel->RBCTR & (~(uint32_t)((0x7UL) << (uint32_t)interrupt_node))) |
                              (service_request << (uint32_t)interrupt_node));
}

void XMC_USIC_Enable(XMC_USIC_t *const usic)
{
  if (usic == ((USIC_GLOBAL_TypeDef *) 0x40030008UL))
  {
  ...
  else if (usic == ((USIC_GLOBAL_TypeDef *) 0x48020008UL))
  {
  ...
  else if (usic == ((USIC_GLOBAL_TypeDef *) 0x48024008UL))
  {
...
void XMC_USIC_Disable(XMC_USIC_t *const usic)
{
  if (usic == (XMC_USIC_t *)((USIC_GLOBAL_TypeDef *) 0x40030008UL))
  {
  ...
  else if (usic == (XMC_USIC_t *)((USIC_GLOBAL_TypeDef *) 0x48020008UL))
  {
  ...
  else if (usic == (XMC_USIC_t *)((USIC_GLOBAL_TypeDef *) 0x48024008UL))
  {

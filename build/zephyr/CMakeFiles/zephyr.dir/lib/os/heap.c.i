# 1 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
...
# 251 "/home/sebin/thesis/zephyrproject/zephyr/include/sys/sys_heap.h"
                                                    dump_chunks);
# 7 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 2
...
# 8 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 2
# 1 "/home/sebin/thesis/zephyrproject/zephyr/include/sys/heap_listener.h" 1
# 11 "/home/sebin/thesis/zephyrproject/zephyr/include/sys/heap_listener.h"
...
# 12 "/home/sebin/thesis/zephyrproject/zephyr/include/sys/heap_listener.h" 2
...
# 9 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 2
...
# 10 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 2
...
# 11 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 2
...
# 265 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.h"
                                           dump_chunks);
# 12 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 2
...
{
 if (mem == 
# 154 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
           ((void *)0)
# 154 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
               ) {
  return;
 }
 ...
 set_chunk_used(h, c, 
# 176 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                     0
# 176 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                          );
# 186 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 free_chunk(h, c);
}
...
static chunkid_t alloc_chunk(struct z_heap *h, chunksz_t sz)
{
 ...
 ;
# 221 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 if (b->next) {
...
void *sys_heap_alloc(struct sys_heap *heap, size_t bytes)
{
 ...
 if (bytes == 0U || size_too_big(h, bytes)) {
  return 
# 258 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 258 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
            ;
 }
 ...
 if (c == 0U) {
  return 
# 264 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 264 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
            ;
 }
 ...
 set_chunk_used(h, c, 
# 273 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                     1
# 273 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                         );

 mem = chunk_mem(h, c);
# 286 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 return mem;
}
...
void *sys_heap_aligned_alloc(struct sys_heap *heap, size_t align, size_t bytes)
{
 struct z_heap *h = heap->heap;
 size_t gap, rew;
# 301 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 rew = align & -align;
 if (align != rew) {
  align -= rew;
 ...
 if (bytes == 0 || size_too_big(h, bytes)) {
  return 
# 315 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 315 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
            ;
 }
 ...
 if (c0 == 0) {
  return 
# 327 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 327 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
            ;
 }
 uint8_t *mem = chunk_mem(h, c0);


 mem = (uint8_t *) (((unsigned long)(mem + rew) + ((unsigned long)(align) - 1)) & ~((unsigned long)(align) - 1)) - rew;
 chunk_unit_t *end = (chunk_unit_t *) (((unsigned long)(mem + bytes) + ((unsigned long)(8U) - 1)) & ~((unsigned long)(8U) - 1));
 ...
 set_chunk_used(h, c, 
# 352 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                     1
# 352 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                         );
# 362 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 return mem;
}
          ...
          size_t align, size_t bytes)
{
 ...
 if (ptr == 
# 371 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
           ((void *)0)
# 371 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
               ) {
 ...
 if (bytes == 0) {
  ...
  return 
# 376 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 376 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
            ;
 }
 ...
 if (size_too_big(h, bytes)) {
  return 
# 382 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
        ((void *)0)
# 382 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
            ;
 }
...
# 406 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
  split_chunks(h, c, c + chunks_need);
  set_chunk_used(h, c, 
# 407 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                      1
# 407 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                          );
  free_chunk(h, c + chunks_need);
# 417 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
  return ptr;
 } else if (!chunk_used(h, rc) &&
     (chunk_size(h, c) + chunk_size(h, rc) >= chunks_need)) {

  chunksz_t split_size = chunks_need - chunk_size(h, c);
# 431 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
  ...
  merge_chunks(h, c, rc);
  set_chunk_used(h, c, 
# 439 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                      1
# 439 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                          );
# 448 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
  return ptr;
 } else {
  ;
 }
# 460 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 void *ptr2 = sys_heap_aligned_alloc(heap, align, bytes);

 if (ptr2 != 
# 462 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
            ((void *)0)
# 462 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                ) {
  size_t prev_size = chunksz_to_bytes(h, chunk_size(h, c)) - align_gap;

  
# 465 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3
 ((__builtin_object_size(
# 465 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
 ptr2
# 465 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3
...
void sys_heap_init(struct sys_heap *heap, void *mem, size_t bytes)
{
 ...
 uintptr_t addr = (((unsigned long)(mem) + ((unsigned long)(8U) - 1)) & ~((unsigned long)(8U) - 1));
 uintptr_t end = ((unsigned long)((uint8_t *)mem + bytes) & ~((unsigned long)(8U) - 1));
 ...
 set_chunk_used(h, 0, 
# 516 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                     1
# 516 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                         );
...
# 525 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c" 3 4
                           1
# 525 "/home/sebin/thesis/zephyrproject/zephyr/lib/os/heap.c"
                               );
